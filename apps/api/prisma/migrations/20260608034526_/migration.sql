...
-- CreateEnum
CREATE TYPE "AssignmentSubmissionStatus" AS ENUM ('PENDING', 'GRADED', 'LATE');
...
-- CreateTable
CREATE TABLE "AssignmentMcqOption" (
    "id" TEXT NOT NULL,
    "questionId" TEXT NOT NULL,
    "optionText" TEXT NOT NULL,
    "isCorrect" BOOLEAN NOT NULL DEFAULT false,

    CONSTRAINT "AssignmentMcqOption_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "StudentQuestionResponse" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "StudentQuestionResponse_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "StudentQuestionResponse_submissionId_questionId_key" ON "StudentQuestionResponse"("submissionId", "questionId");
...
-- AddForeignKey
ALTER TABLE "AssignmentMcqOption" ADD CONSTRAINT "AssignmentMcqOption_questionId_fkey" FOREIGN KEY ("questionId") REFERENCES "AssignmentQuestion"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "StudentQuestionResponse" ADD CONSTRAINT "StudentQuestionResponse_submissionId_fkey" FOREIGN KEY ("submissionId") REFERENCES "AssignmentSubmission"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StudentQuestionResponse" ADD CONSTRAINT "StudentQuestionResponse_questionId_fkey" FOREIGN KEY ("questionId") REFERENCES "AssignmentQuestion"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StudentQuestionResponse" ADD CONSTRAINT "StudentQuestionResponse_selectedOptionId_fkey" FOREIGN KEY ("selectedOptionId") REFERENCES "AssignmentMcqOption"("id") ON DELETE CASCADE ON UPDATE CASCADE;
