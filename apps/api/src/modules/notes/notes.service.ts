...
export const notesService = {
  async list(userId: string, courseId?: string, moduleId?: string, isSticky?: boolean) {
  ...
  async create(data: { userId: string; courseId: string; moduleId?: string; title: string; body: string; isSticky?: boolean }) {
