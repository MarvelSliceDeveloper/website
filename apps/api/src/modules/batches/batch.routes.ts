...
router.get('/instructors', requireRole([UserRole.ADMIN, UserRole.INSTRUCTOR]), batchController.getInstructors);

// GET /api/admin/batches/courses — list published courses
router.get('/courses', requireRole([UserRole.ADMIN, UserRole.INSTRUCTOR]), batchController.getCourses);

// --- Batch CRUD ---

// GET /api/admin/batches — list all batches
router.get('/', requireRole([UserRole.ADMIN, UserRole.INSTRUCTOR]), batchController.list);
...
router.get('/:id', requireRole([UserRole.ADMIN, UserRole.INSTRUCTOR]), batchController.getById);
...
router.get('/:id/students', requireRole([UserRole.ADMIN, UserRole.INSTRUCTOR]), batchController.listStudents);

// POST /api/admin/batches/:id/students — add students to batch
router.post('/:id/students', requireRole([UserRole.ADMIN]), batchController.addStudents);

// DELETE /api/admin/batches/:id/students/:uid — remove student
router.delete('/:id/students/:uid', requireRole([UserRole.ADMIN]), batchController.removeStudent);
