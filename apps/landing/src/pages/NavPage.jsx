  ...
  if (!hasContent) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        <h1 className="text-3xl font-bold text-dark-navy mb-4">
          Page Not Found
        </h1>
  ...
  return (
    <div>
      {data.hero_image && (
        <Reveal
          variant="fadeIn"
          className="w-full max-w-[1900px] mx-auto h-[220px] sm:h-[320px] lg:h-[400px] overflow-hidden"
        >
          <img
            src={data.hero_image}
            alt=""
      ...
      {!data.heading && !data.subheading && data.courses?.length > 0 && (
        <Reveal className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 text-center">
          ...
          <p className="text-base sm:text-lg text-text-gray max-w-2xl mx-auto">
            Explore our {data.navLabel?.toLowerCase()} courses
          </p>
        </Reveal>
      )}
        ...
        data.sections
          ...
          .map((section, i) => (
            <Reveal
              key={i}
              variant="up"
              className={`py-10 sm:py-14 ${i % 2 === 0 ? "bg-white" : "bg-gray-50"}`}
            >
      ...
      {data.courses?.length > 0 && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-20">
          <Reveal
            as="h2"
            className="text-xl sm:text-2xl font-bold text-dark-navy mb-6 sm:mb-8"
          >
