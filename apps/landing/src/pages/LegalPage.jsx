  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      <Reveal className="mb-10 sm:mb-12">
        {data.title && <h1 className="text-3xl sm:text-4xl font-extrabold text-dark-navy mb-4">{data.title}</h1>}
        {data.intro && <p className="!text-text-gray text-base sm:text-lg">{data.intro}</p>}
      </Reveal>
