  ...
  return (
    <section className="pt-10 pb-16 bg-neutral-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Reveal className="lg:col-span-7">
              <div className="space-y-4">
                {classes.slice(0, 4).map((cls, i) => (
                  <div
                    key={cls.id}
                    className="flex flex-col sm:flex-row items-center sm:items-center text-center sm:text-left gap-4 rounded-2xl border border-gray-200 bg-white shadow-md hover:shadow-lg hover:border-brand-blue/40 transition-all p-5"
                  >
                    <div className="flex items-center gap-4 flex-1 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <p className="font-semibold text-dark-navy text-base leading-snug truncate">
                            {cls.course_name}
                          </p>
                          {cls.batch && (
                            <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-blue-50 text-brand-blue text-[11px] font-bold shrink-0">
                              {cls.batch}
                            </span>
                          )}
                        </div>
            ...
            {imageUrl && (
              <Reveal className="lg:col-span-5 min-w-0 flex items-center justify-center">
                {imageLink ? (
                  <a
                    href={imageLink}
                    target={imageLink.startsWith("http") ? "_blank" : undefined}
                    rel={
                      imageLink.startsWith("http")
                        ? "noopener noreferrer"
                        : undefined
                    }
                    className="block w-full h-[320px] lg:w-[480px] lg:h-[400px] rounded-2xl overflow-hidden border border-gray-200 shadow-md group lg:-translate-y-[1%]"
                  >
                    <img
                      src={imageUrl}
        ...
        {classes.length === 0 && (
          <p className="text-center text-text-gray mt-12">
