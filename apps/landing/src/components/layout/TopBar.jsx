      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between py-2">
        ...
        <div className="flex items-center gap-2 text-xs lg:text-sm">
          ...
          <a
            ...
            onClick={() => trackCtaClick("Sign Up", "topbar")}
          >
            SIGN UP
          </a>
          <span className="text-white/40">|</span>
          <div className="flex items-center gap-3 ml-2">
            <a
              href={social.twitter || "#"}
              aria-label="Twitter"
              className="flex h-5 w-5 items-center justify-center rounded-full border border-white/30 bg-white/10 text-white transition-all duration-300 hover:border-transparent hover:bg-brand-orange hover:-translate-y-0.5"
            >
