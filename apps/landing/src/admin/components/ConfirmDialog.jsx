...
export default function ConfirmDialog({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      />
      <div
        className="relative bg-white rounded-xl shadow-2xl max-w-sm w-full p-6 border border-admin-200 max-h-[85vh] overflow-y-auto"
        role="dialog"
        aria-modal="true"
      >
        ...
        <div className="flex justify-end gap-3">
          <button
            onClick={onCancel}
            className="px-4 py-2 rounded-lg text-sm font-medium text-admin-700 hover:bg-admin-100 transition-all"
          >
            Cancel
          </button>
          <button
