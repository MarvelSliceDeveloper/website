    ...
    <AuthProvider>
      <Routes>
        ...
        >
          ...
          <Route
            path="home-page"
            element={<Navigate to="/admin/home/hero" replace />}
          />
          ...
          <Route
            ...
            element={<TrainingCategoriesManager />}
          />
          ...
          <Route
            path="career-contact-submissions"
            element={<CareerContactSubmissions />}
          />
          ...
          <Route
            path="upcoming-courses/new"
            element={<UpcomingClassAdd key="new" />}
          />
          <Route
            path="upcoming-courses/:id"
            element={<UpcomingClassAdd key="edit" />}
          />
          <Route path="testimonials" element={<TestimonialsManager />} />
          <Route
            path="testimonials/new"
            element={<TestimonialEditor key="new" />}
          />
          <Route
            path="testimonials/:id"
            element={<TestimonialEditor key="edit" />}
          />
          <Route
            path="upcoming-class-submissions"
            element={<UpcomingClassSubmissions />}
          />
          <Route path="course-interests" element={<CourseInterests />} />
          <Route
            path="upcoming-course-interests"
            element={<UpcomingCourseInterests />}
          />
          <Route
          ...
          <Route
            path="terms-policy"
            element={<LegalPageEditor key="terms" pageKey="terms" />}
          />
          <Route
            path="privacy-policy"
            element={<LegalPageEditor key="privacy" pageKey="privacy" />}
          />
