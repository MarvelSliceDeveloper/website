...
export default function UpcomingClassAdd() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setSaved(true);
      setTimeout(
        () => navigate("/admin/upcoming-courses", { replace: true }),
        500,
      );
  ...
  if (loading)
    return (
      <div className="p-8 text-center text-neutral-500">
        Loading upcoming class...
      </div>
    );

  return (
    <PageShell
      backTo="/admin/upcoming-courses"
      title={isNew ? "Add Upcoming Class" : "Edit Upcoming Class"}
    ...
    >
      ...
      <div className="bg-white border border-gray-300 rounded-xl shadow-sm p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (errors.courseName)
                  setErrors((p) => ({ ...p, courseName: undefined }));
              }}
          ...
          <div>
            <label className="block text-sm font-semibold text-black mb-1">
              Date & Time <span className="text-destructive-500">*</span>
            </label>
            <DateTimePicker
              value={dateTime}
              onChange={(v) => {
        ...
        <div className="pt-4 mt-6 border-t border-admin-200">
          ...
          <span className="ml-3 text-sm font-medium text-black align-middle">
            {isActive
              ...
              : "Inactive — hidden from home page"}
          </span>
        </div>
      </div>
      <SaveCancelBar
        ...
        saveError={saveError}
        onSave={handleSave}
        onDiscard={() => navigate("/admin/upcoming-courses")}
        submitLabel="Save"
      />
    </PageShell>
  );
