    ...
    async function loadData() {
      ...
      if (!isNew) {
        ...
        relatedRes.forEach((res, i) => {
          if (res.data)
            setService((prev) => ({ ...prev, [related[i][0]]: res.data }));
        });
      }
      setLoading(false);
    }
                ...
                <div className="flex flex-wrap gap-6 pt-2">
                  ...
                  <label className="flex items-center gap-2 text-sm cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        update("placement_support", e.target.checked)
                      }
                      className="rounded"
                    />
                    Placement Support
                        ...
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <button
                            onClick={() =>
                              update(
                                "curriculum",
                                service.curriculum.filter((_, j) => j !== i),
                              )
                            }
                            ...
                            <div key={j} className="flex items-center gap-2">
                              ...
                              <button
                                onClick={() => {
                                  ...
                                  n[i] = {
                                    ...n[i],
                                    items: n[i].items.filter((_, k) => k !== j),
                                  };
                                  update("curriculum", n);
                                }}
                    ...
                    >
                      <button
                        onClick={() =>
                          update(
                            "benefits",
                            service.benefits.filter((_, j) => j !== i),
                          )
                        }
                    ...
                    >
                      <button
                        onClick={() =>
                          update(
                            "testimonials",
                            service.testimonials.filter((_, j) => j !== i),
                          )
                        }
                        className="absolute top-3 right-3 text-red-500 hover:text-red-600"
                      >
                    ...
                    >
                      <button
                        onClick={() =>
                          update(
                            "gallery",
                            service.gallery.filter((_, j) => j !== i),
                          )
                        }
                        className="absolute top-3 right-3 text-red-500 hover:text-red-600"
                      >
                    ...
                    >
                      <button
                        onClick={() =>
                          update(
                            "statistics",
                            service.statistics.filter((_, j) => j !== i),
                          )
                        }
                        className="absolute top-3 right-3 text-red-500 hover:text-red-600"
                      >
