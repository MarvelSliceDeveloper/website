...
export default function InternshipsManager() {
  ...
  async function save(e) {
    ...
    const payload = {
      ...
      role_category_id:
        form.role_category_id && form.role_category_id !== ""
          ? form.role_category_id
          : null,
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex items-center justify-end gap-1.5">
          <button
            onClick={() => navigate(`/admin/internships/${row.id}`)}
  ...
  return (
    ...
    >
      <div className="bg-white shadow-sm border border-admin-200 overflow-hidden">
        {internships.length > 0 ? (
          ...
          <EmptyState
            ...
            description="Get started by creating your first internship opportunity."
      ...
      {showForm && (
        <div
          className="fixed inset-0 z-50 flex items-start justify-center p-4 bg-black/40 pt-12 sm:pt-20 cursor-pointer"
          onClick={closeForm}
        >
          <div
            className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col cursor-auto overflow-hidden"
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-admin-200 bg-gray-50/50 shrink-0">
              ...
              <button
                type="button"
                onClick={closeForm}
                className="p-1.5 text-blue-600 hover:text-blue-700 rounded-lg hover:bg-blue-50 rounded-lg transition-colors cursor-pointer"
              >
              ...
              <form id="internshipForm" onSubmit={save} className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-3 py-2 border border-admin-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-admin-500/20 focus:border-admin-500 transition-all bg-white"
                    >
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="e.g. Freshers / 0-1 year"
                      required
                      className="w-full px-3 py-2 border border-admin-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-admin-500/20 focus:border-admin-500 transition-all"
                    />
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g. https://apply.example.com/internship"
                    className="w-full px-3 py-2 border border-admin-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-admin-500/20 focus:border-admin-500 transition-all"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-admin-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-admin-500/20 focus:border-admin-500 transition-all resize-y"
                  />
                </div>
