    ...
    <div>
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 px-3 py-2.5 bg-white border border-admin-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-admin-500/20 transition-all"
...
export default function ContactPageEditor() {
  ...
  const { dirty, reset } = useDirty(
    [hero, contactContent, formConfig, faqs],
    loading,
  );
    ...
    async function resolve() {
      ...
      if (item?.id) {
        ...
        if (page) {
          ...
          const contactFormSec = secs.find(
            (s) => s.section_type === "contact_form",
          );
          if (contactFormSec) {
            setContactContent({
              ...DEFAULT_CONTACT_CONTENT,
              ...contactFormSec.content,
            });
          } else {
            const contactInfoSec = secs.find(
              (s) => s.section_type === "contact_info",
            );
            if (contactInfoSec) {
  ...
  async function handleSave(e) {
    ...
    const sections = [
      ...
      contactContent.map_embed_url
        ? { section_type: "map_embed", content: contactContent.map_embed_url }
        : null,
    ].filter(Boolean);
  ...
  const inputCls =
    "w-full px-3 py-2.5 bg-white border border-admin-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-admin-500/20 transition-all";
  const labelCls =
    "block text-xs font-semibold text-neutral-700 mb-1.5 uppercase tracking-wider";

  const tabs = [
    { id: "hero-section", title: "Hero", icon: FiHome },
    {
      id: "left-side-company-details",
                  ...
                  <div className="space-y-4">
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          value={contactContent.left_heading}
                          onChange={(e) =>
                            updateContent("left_heading", e.target.value)
                          }
                          className={inputCls}
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={contactContent.left_heading_line_2 || ""}
                          onChange={(e) =>
                            updateContent("left_heading_line_2", e.target.value)
                          }
                          className={inputCls}
                          placeholder="Second line of heading"
                        />
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={contactContent.left_subtitle}
                          onChange={(e) =>
                            updateContent("left_subtitle", e.target.value)
                          }
                          className={inputCls}
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          value={contactContent.display_phone}
                          onChange={(e) =>
                            updateContent("display_phone", e.target.value)
                          }
                          className={inputCls}
                      ...
                      <div>
                        ...
                        <input
                          type="tel"
                          value={contactContent.tel_link}
                          onChange={(e) =>
                            updateContent("tel_link", e.target.value)
                          }
                          className={inputCls}
                    ...
                    <div className="grid sm:grid-cols-3 gap-4">
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            type="color"
                            value={contactContent.gradient_start}
                            onChange={(e) =>
                              updateContent("gradient_start", e.target.value)
                            }
                            className="w-10 h-10 rounded-lg border border-admin-200 cursor-pointer"
                          />
                          <input
                            type="text"
                            value={contactContent.gradient_start}
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            type="color"
                            value={contactContent.gradient_end}
                            onChange={(e) =>
                              updateContent("gradient_end", e.target.value)
                            }
                            className="w-10 h-10 rounded-lg border border-admin-200 cursor-pointer"
                          />
                          <input
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            type="color"
                            value={contactContent.heading_color || "#ffffff"}
                            onChange={(e) =>
                              updateContent("heading_color", e.target.value)
                            }
                            className="w-10 h-10 rounded-lg border border-admin-200 cursor-pointer"
                          />
                          <input
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            type="color"
                            value={
                              contactContent.heading_line_2_color || "#ffffff"
                            }
                            onChange={(e) =>
                              updateContent(
                                "heading_line_2_color",
                                e.target.value,
                              )
                            }
                            className="w-10 h-10 rounded-lg border border-admin-200 cursor-pointer"
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            type="color"
                            value={contactContent.subheading_color || "#ffffff"}
                            onChange={(e) =>
                              updateContent("subheading_color", e.target.value)
                            }
                            className="w-10 h-10 rounded-lg border border-admin-200 cursor-pointer"
                          />
                          <input
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            type="color"
                            value={contactContent.text_color || "#ffffff"}
                            onChange={(e) =>
                      ...
                      <div className="sm:col-start-3">
                        ...
                        <div className="flex items-center gap-3 justify-end">
                          ...
                          >
                            <span
                              className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${contactContent.show_shadow ? "translate-x-6" : "translate-x-1"}`}
                            />
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs text-neutral-500 mt-0.5">
                          Embed a Google Maps location below the contact
                          section.
                        </p>
                      </div>
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateContent("map_embed_url", e.target.value)
                        }
                        className={inputCls}
                        placeholder="https://www.google.com/maps/embed?pb=..."
                      />
                      <p className="text-xs text-neutral-400 mt-1">
                        Paste the <strong>src</strong> URL from a Google Maps
                        embed iframe. Leave empty to hide the map.
                      </p>
                    </div>
                  </div>
                </div>
