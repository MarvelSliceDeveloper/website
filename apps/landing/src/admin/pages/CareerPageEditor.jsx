...
function buildDefaultFormConfig() {
  return {
    ...
    fields: Object.fromEntries(
      Object.entries(FORM_FIELD_DEFAULTS).map(([k, v]) => [
        k,
        {
          label: v.label,
          enabled: v.enabled,
...
export default function CareerPageEditor() {
  ...
  const [section1, setSection1] = useState({
    ...
    description:
      "Join a team that's passionate about innovation, collaboration, and making a real impact. Your dream role is waiting.",
    categoriesHeading: "",
  ...
  }, [roleCategories.length, catPageSize]);

  const { dirty, reset } = useDirty(
    [hero, section1, section2, cta, formConfig, openings],
    loading,
  );
    ...
    async function load() {
      ...
      if (content) {
        ...
        setSection1({
          ...
          subtitle:
            fc.subtitle ||
            content.section1_subheading ||
            "Find Your Role. Find Your Fit.",
          description: fc.description || content.section1_description || "",
          categoriesHeading: fc.categoriesHeading || "",
          categoriesSubtitle:
            fc.categoriesSubtitle || "Find the role that fits you best",
        });
        setSection2({
          heading: content.section2_heading || "Job Openings",
          subheading: content.section2_subheading || "",
          heading_align: fc.section2_heading_align || "center",
          subheading_align: fc.section2_subheading_align || "center",
          eyebrow: fc.section2_eyebrow || "",
        });
        ...
        if (rawForm.enabled !== undefined || Object.keys(rawForm).length > 0) {
          ...
          content.form_config &&
          typeof content.form_config === "object" &&
          content.form_config.enabled !== undefined
        ) {
          setFormConfig({
  ...
  function openCategoryForm() {
    setCategoryForm({
      name: "",
      display_order: roleCategories.length,
      is_active: true,
    });
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    >
                      <span
                        className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${hero.hero_image ? "translate-x-4" : "translate-x-0.5"}`}
                      />
                    </button>
                  </div>
                  {hero.hero_image ? (
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={section1.headline}
                    onChange={(e) =>
                      setSection1({ ...section1, headline: e.target.value })
                    }
                    placeholder="Hiring"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSection1({ ...section1, subtitle: e.target.value })
                    }
                    placeholder="Find Your Role. Find Your Fit."
                    className={inputClass}
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    placeholder="Brief description about working at your company..."
                    className={inputClass}
                  />
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={section1.categoriesHeading}
                    onChange={(e) =>
                      setSection1({
                        ...section1,
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={section1.categoriesSubtitle}
                    onChange={(e) =>
                      setSection1({
                        ...section1,
            ...
            <div className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={cta.heading}
                    onChange={(e) =>
                      setCta({ ...cta, heading: e.target.value })
                    }
                    placeholder="Ready to start your dream career?"
                    className={inputClass}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCta({ ...cta, subheading: e.target.value })
                    }
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  placeholder="Talk to our team today and find the perfect role for you."
                  className={inputClass}
                />
              </div>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={cta.cta_text}
                    onChange={(e) =>
                      setCta({ ...cta, cta_text: e.target.value })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    value={cta.cta_link}
                    onChange={(e) =>
                      setCta({ ...cta, cta_link: e.target.value })
                    }
              ...
              <div>
                <ImageUploader
                  ...
                  onChange={(v) => setCta({ ...cta, background_image: v })}
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-admin-200 bg-blue-600">
                          <th className="text-left px-3 py-2.5 font-semibold text-white">
                            Name
                          </th>
                          <th className="text-center px-3 py-2.5 font-semibold text-white">
                            Order
                          </th>
                          <th className="text-center px-3 py-2.5 font-semibold text-white">
                            Active
                          </th>
                          <th className="text-right px-3 py-2.5 font-semibold text-white">
                            Actions
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                        {(() => {
                          ...
                          const paginated = roleCategories.slice(
                            start,
                            start + catPageSize,
                          );
                          ...
                          return paginated.map((cat, i) => (
                            <tr
                              key={cat.id}
                              className={`border-b border-gray-100 hover:bg-gray-50 transition-colors ${(start + i) % 2 === 1 ? "bg-gray-50" : "bg-white"}`}
                            >
                  ...
                  <div className="flex items-center justify-between px-3 py-3 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="px-2 text-xs text-neutral-500">
                        {catPage} /{" "}
                        {Math.ceil(roleCategories.length / catPageSize) || 1}
                      </span>
                      <button
                        type="button"
                        onClick={() =>
                          setCatPage((p) =>
                            Math.min(
                              Math.ceil(roleCategories.length / catPageSize),
                              p + 1,
                            ),
                          )
                        }
