...
export default function TrainingEditor() {
    ...
    async function loadData() {
      ...
      if (!isNew) {
        ...
        relatedRes.forEach((res, i) => {
          if (res.data)
            setTraining((prev) => ({ ...prev, [related[i][0]]: res.data }));
        });
      }
      setLoading(false);
    }
  ...
  async function handleSave() {
    ...
    try {
      ...
      queryClient.invalidateQueries({
        queryKey: ["trainingProgram", training.slug],
      });
  ...
  function canNext() {
    if (step === 0)
      return training.title.trim() !== "" && training.slug.trim() !== "";
    return true;
  }
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    update("sort_order", e.target.valueAsNumber ?? 0)
                  }
            ...
            <div className="space-y-8">
                    ...
                    onClick={() =>
                      update("trainingModules", [
                        ...training.trainingModules,
                        {
                          ...
                          topics: [],
                          outcomes: [],
                          sort_order: training.trainingModules.length,
                        },
                      ])
                    }
                    label="Add Module"
                ...
                <div className="space-y-3">
                  {training.trainingModules.length === 0 && (
                    <div className="text-center py-8 text-neutral-400 bg-white rounded-lg border-2 border-dashed border-admin-200">
                      ...
                      <p className="text-sm">
                        No modules yet. Click "Add Module" to build your
                        curriculum.
                      </p>
                    </div>
                  )}
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                          onClick={() =>
                            update(
                              "trainingModules",
                              training.trainingModules.filter(
                                (_, j) => j !== i,
                              ),
                            )
                          }
                          ...
                          <div key={j} className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => {
                                ...
                                n[i] = {
                                  ...n[i],
                                  topics: n[i].topics.filter((_, k) => k !== j),
                                };
                                update("trainingModules", n);
                              }}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            n[i] = {
                              ...n[i],
                              sort_order: e.target.valueAsNumber ?? i,
                            };
                            update("trainingModules", n);
                          }}
                    ...
                    onClick={() =>
                      update("trainingSkills", [
                        ...training.trainingSkills,
                        {
                          ...
                          title: "",
                          description: "",
                          sort_order: training.trainingSkills.length,
                        },
                      ])
                    }
                    label="Add Skill"
                    ...
                    >
                      <button
                        onClick={() =>
                          update(
                            "trainingSkills",
                            training.trainingSkills.filter((_, j) => j !== i),
                          )
                        }
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <AddButton
                    onClick={() =>
                      update("trainingBenefits", [
                        ...training.trainingBenefits,
                        {
                          icon: "",
                          title: "",
                          description: "",
                          sort_order: training.trainingBenefits.length,
                        },
                      ])
                    }
                    label="Add Benefit"
                    ...
                    >
                      <button
                        onClick={() =>
                          update(
                            "trainingBenefits",
                            training.trainingBenefits.filter((_, j) => j !== i),
                          )
                        }
                        className="absolute top-3 right-3 text-red-500 hover:text-red-600"
                      >
                    ...
                    >
                      <button
                        onClick={() =>
                          update(
                            "testimonials",
                            training.testimonials.filter((_, j) => j !== i),
                          )
                        }
                        className="absolute top-3 right-3 text-red-500 hover:text-red-600"
                      >
                    ...
                    >
                      <button
                        onClick={() =>
                          update(
                            "gallery",
                            training.gallery.filter((_, j) => j !== i),
                          )
                        }
                        className="absolute top-3 right-3 text-red-500 hover:text-red-600"
                      >
                    ...
                    >
                      <button
                        onClick={() =>
                          update(
                            "statistics",
                            training.statistics.filter((_, j) => j !== i),
                          )
                        }
                        className="absolute top-3 right-3 text-red-500 hover:text-red-600"
                      >
