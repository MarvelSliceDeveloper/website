...
const navGroups = [
...

  {
    ...
    items: [
      { to: "/admin/training/new", label: "Add Program", icon: FiPlusCircle },
      {
        ...
        icon: FiZap,
        catchSubRoutes: true,
        siblingRoutes: ["/admin/training/new"],
      },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/internships/new", label: "Add Intern", icon: FiPlusCircle },
      {
        ...
        icon: FiClock,
        catchSubRoutes: true,
        siblingRoutes: ["/admin/internships/new"],
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        to: "/admin/career-contact-submissions",
        label: "Career Enquiry",
        icon: FiMail,
      },
      {
        to: "/admin/brochure-downloads",
      ...
      {
        to: "/admin/about-submissions",
        label: "About Submissions",
        icon: FiInfo,
      },
      {
        to: "/admin/upcoming-class-submissions",
        label: "Upcoming Class Registrations",
        icon: FiCalendar,
      },
      {
      ...
      {
        to: "/admin/upcoming-course-interests",
        label: "Upcoming Course Interests",
        icon: FiBell,
      },
      {
        to: "/admin/chat-submissions",
    ...
    items: [
      {
        ...
        children: [
          {
            to: "/admin/courses/wizard?category=Software%20Learning",
            label: "Add Course",
            icon: FiPlusCircle,
          },
          {
            to: "/admin/courses?category=Software%20Learning",
            label: "View Courses",
            icon: FiBookOpen,
          },
        ],
      },
      {
        ...
        children: [
          {
            to: "/admin/courses/wizard?category=Competitive%20Exam",
            label: "Add Course",
            icon: FiPlusCircle,
          },
          {
            to: "/admin/courses?category=Competitive%20Exam",
            label: "View Courses",
            icon: FiBookOpen,
          },
        ],
      ...
      },
      {
        ...
        children: [
          {
            to: "/admin/upcoming-courses/new",
            label: "Add",
            icon: FiPlusCircle,
          },
          {
            to: "/admin/upcoming-courses",
            label: "View",
            icon: FiCalendar,
            catchSubRoutes: true,
            siblingRoutes: ["/admin/upcoming-courses/new"],
          },
        ],
      },
  ...
  },
  {
    ...
    items: [
      { to: "/admin/testimonials/new", label: "Add", icon: FiPlusCircle },
      {
        ...
        icon: FiStar,
        catchSubRoutes: true,
        siblingRoutes: ["/admin/testimonials/new"],
      },
    ],
  },
  {
    ...
    items: [
      { to: "/admin/blog/new", label: "Add Blog", icon: FiPlusCircle },
      {
        ...
        icon: FiFileText,
        catchSubRoutes: true,
        siblingRoutes: ["/admin/blog/categories", "/admin/blog/new"],
      },
    ...
    items: [
      {
        ...
        children: [
          ...
          {
            to: "/admin/nav-menu?section=Software%20Learning&tab=view",
            label: "View Menu",
            icon: FiMenu,
          },
        ],
      },
      {
        ...
        children: [
          {
            to: "/admin/nav-menu?section=Competitive%20Exam&tab=add",
            label: "Add Menu",
            icon: FiPlusCircle,
          },
          {
            to: "/admin/nav-menu?section=Competitive%20Exam&tab=view",
            label: "View Menu",
            icon: FiMenu,
          },
        ],
      },
      {
        ...
        children: [
          {
            to: "/admin/nav-menu?section=Services&tab=add",
            label: "Add Menu",
            icon: FiPlusCircle,
          },
          {
            to: "/admin/nav-menu?section=Services&tab=view",
            label: "View Menu",
            icon: FiMenu,
          },
        ],
      },
      {
        ...
        children: [
          {
            to: "/admin/nav-menu?section=Training&tab=add",
            label: "Add Menu",
            icon: FiPlusCircle,
          },
          {
            to: "/admin/nav-menu?section=Training&tab=view",
            label: "View Menu",
            icon: FiMenu,
          },
        ],
  ...
  },
  {
    label: "Uploads",
    icon: FiLayers,
    items: [{ to: "/admin/media", label: "Media Library", icon: FiImage }],
  },
  {
    label: "Settings",
    icon: FiSettings,
    items: [
      {
        to: "/admin/site-settings?section=general",
        label: "Site Settings",
        icon: FiSettings,
      },
...
function isActive(pathname, item) {
  ...
  const fullSearch = pathname.includes("?")
  ...
  if (
    item.catchSubRoutes &&
    fullPath.replace(/\/$/, "").startsWith(itemPath + "/")
  ) {
    const nextSeg = fullPath
      .replace(/\/$/, "")
    ...
    <div>
      <button
        ...
        className={`cursor-pointer w-full flex items-center gap-2 px-3 py-1.5 text-sm rounded-md transition-all duration-200 ${
          hasActiveChild
            ? ""
            : "text-[#939AB3] hover:text-white hover:bg-white/5 hover:translate-x-0.5"
        }`}
      ...
      >
        ...
        <span
          className="truncate"
          style={hasActiveChild ? activeLabelStyle : undefined}
        >
          {item.label}
        </span>
      </button>
      <Collapsible open={open}>
        <div
          className="ml-3 pl-2 mt-0.5 mb-1 space-y-0.5"
          ...
          {item.children.map((child) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className="truncate"
                  style={act ? activeLabelStyle : undefined}
                >
                  {child.label}
                </span>
              </NavLink>
...
function SidebarNav({ group, idx, pathname, isOpen, onToggle, onNavigate }) {
  const [activeNested, setActiveNested] = useState(() => {
    const activeIdx = group.items.findIndex(
      (item) =>
  ...
  if (group.items.length === 1 && group.items[0].to) {
    return (
      ...
      >
        ...
        <span
          className="truncate"
          style={groupActive ? activeLabelStyle : undefined}
        >
          {group.label}
        </span>
      </NavLink>
        ...
        <div className="flex items-center rounded-md overflow-hidden">
          <NavLink
            ...
            className={`cursor-pointer flex-1 flex items-center gap-2.5 px-3 py-2 text-sm rounded-md transition-all duration-200 ${
              groupActive
                ? "font-semibold"
                : "text-[#939AB3] hover:text-white hover:bg-white/5"
            }`}
            style={groupActive ? { color: "#ffffff" } : undefined}
          >
            <Icon
...
export default function Sidebar({ mobileOpen, onMobileClose }) {
  ...
  const content = (
    ...
    >
      <div
        className="flex items-center justify-between h-14 shrink-0 px-4 border-b border-gray-200"
      ...
      >
        ...
        >
          <img
            src={
              settings?.logo_url || settings?.logo || "/apple-touch-icon.png"
            }
            alt="Marvel Slice Logo"
            className="w-8 h-8 object-contain rounded-md shrink-0 transition-transform duration-200 group-hover:scale-105"
          />
          <div className="min-w-0">
            <span className="text-sm font-bold block leading-tight text-dark-navy">
      ...
      <div className="px-4 py-3 shrink-0 border-t border-white/10">
        <div
          className="flex items-center gap-2.5 px-2 py-2 rounded-md transition-colors duration-200 hover:bg-white/[0.08]"
          style={{ background: "rgba(255,255,255,0.05)" }}
        >
          <div
            className="w-6 h-6 rounded-full flex items-center justify-center text-[9px] font-bold shrink-0 shadow-sm"
            style={{
              background:
                "linear-gradient(to bottom right, rgba(91,80,236,0.4), rgba(91,80,236,0.05))",
              color: "#5B50EC",
            }}
          >
            M
          ...
          <div className="min-w-0">
            <p className="text-xs font-medium" style={{ color: "#939AB3" }}>
              Marvel Slice v1.0
            </p>
            <p className="text-[10px]" style={{ color: "#707897" }}>
              Admin Panel
            </p>
          </div>
        </div>
  ...
  return (
    <>
      <aside
        className="hidden lg:flex lg:flex-col w-60 shrink-0 h-screen overflow-hidden shadow-elevated transition-all duration-300"
        style={{ background: "linear-gradient(to bottom, #0C1028, #0A0E20)" }}
      >
        {content}
      </aside>
      {mobileOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside
            ...
            style={{
              background: "linear-gradient(to bottom, #0C1028, #0A0E20)",
            }}
            role="dialog"
            aria-modal="true"
...
function HierarchicalMobileNav({ onMobileClose, pathname }) {
  const [navStack, setNavStack] = useState([
    { title: "Marvel Slice Admin", items: navGroups },
  ]);
