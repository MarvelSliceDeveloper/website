...
export const BUTTON_VARIANTS = {
  primary:
    "bg-brand-orange text-white font-semibold hover:brightness-90 shadow-sm transition-all",
  "primary-lg":
    "bg-brand-orange text-white font-semibold hover:brightness-90 shadow-lg shadow-brand-orange/25 transition-all",
  secondary:
  ...
  ghost:
    "text-text-gray font-medium hover:text-brand-orange hover:bg-gray-50 transition-all",
  "ghost-red":
  ...
  "link-add":
    "text-brand-orange font-medium hover:text-brand-blue inline-flex items-center gap-1.5 transition-all",
  pill: "bg-gray-100 text-text-gray font-medium hover:bg-gray-200 border border-gray-300 transition-all",
  "pill-active":
    "bg-brand-orange text-white font-medium shadow-sm transition-all",
  "pill-orange":
...
export function isValidVariant(v) {
  return !!BUTTON_VARIANTS[resolveVariant(v)];
}
export function isValidSize(s) {
  return !!BUTTON_SIZES[s];
}
export function isValidShape(s) {
  return !!BUTTON_SHAPES[s];
}
