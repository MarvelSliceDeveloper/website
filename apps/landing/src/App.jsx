...
function CourseNavRedirect() {
  ...
  return (
    <Navigate
      to={`/courses?parent=${parent}&category=${subSlug}&view=list`}
      replace
    />
  );
}
  ...
  const routes = (
    <Routes location={location}>
      ...
      <Route
        ...
        element={<Navigate to="/courses?parent=software-learning" replace />}
      />
      <Route
        path="/competitive-exam"
        element={<Navigate to="/courses?parent=competitive-exam" replace />}
      />
