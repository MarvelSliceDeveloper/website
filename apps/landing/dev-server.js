...
async function handleCareer(body) {
  ...
  try {
    ...
    console.error("[dev-server] Career email failed:", err);
  }
  return { success: true };
}
...
async function handleForm(body) {
  ...
  try {
    ...
    console.error("[dev-server] Form email failed:", err);
  }
  return { success: true };
}
...
async function handleBrochure(body) {
  ...
  try {
    ...
    console.error("[dev-server] Brochure email failed:", err);
  }
  return { success: true };
}
...
async function handleCareerContact(body) {
  ...
  try {
    ...
    console.error("[dev-server] Career contact email failed:", err);
  }
  return { success: true };
}
...
async function handleContact(body) {
  ...
  try {
    ...
    console.error("[dev-server] Contact email failed:", err);
  }
  return { success: true };
}
...
async function handleAbout(body) {
  ...
  try {
    ...
    console.error("[dev-server] About enquiry email failed:", err);
  }
  return { success: true };
}
...
async function handleEnquiry(body) {
  ...
  try {
    ...
    console.error("[dev-server] Course enquiry email failed:", err);
  }
  return { success: true };
}
...
async function handleAdminReply(body) {
  ...
  try {
    ...
    console.error("[dev-server] Admin reply failed:", err);
  }
  return { success: true };
}
