!(function () {
  ...
  const u = Object.keys,
    ...
    v = g("iframe_template_callback"),
    y = g("media_live_embeds"),
    f = g("media_filter_html"),
    x = g("media_url_resolver"),
    _ = g("media_alt_source"),
    k = g("media_poster"),
    A = g("media_dimensions");
  ...
  const $ = O.DOM,
    ...
    C = (e) => {
      ...
      return {
        ...
        altsource: "",
        poster: "",
        width: h(r, "max-width").map(T).getOr(""),
        height: h(r, "max-height").map(T).getOr(""),
      };
    },
    M = (e, t) => {
      let r = {};
  ...
  const N = (e, t = {}) =>
    ...
    P = (e, t) => {
      const r = t.attr("style"),
        o = r ? E.parseStyle(r) : {};
      (s(e.width) && (o["max-width"] = L(e.width)),
        s(e.height) && (o["max-height"] = L(e.height)),
        t.attr("style", E.serializeStyle(o)));
    },
    R = ["source", "altsource"],
    U = (e, t, r, o) => {
      let a = 0,
    ...
    H = (e) => {
      ...
      return t.length > 0 ? j.extend({}, t[0], { url: B(t[0], e) }) : null;
    },
    G = (e, t) => {
      var r;
      const o = j.extend({}, t);
      if (
        ...
        (j.extend(
          o,
          M(null !== (r = o.embed) && void 0 !== r ? r : "", e.schema),
        ),
        !o.source)
      )
        return "";
    ...
    Z = (e, t) => (o) => {
      if (r(o.url) && o.url.trim().length > 0) {
        const r = o.html,
          a = { ...M(r, t.schema), source: o.url, embed: r };
        e.setData(X(a));
      }
    },
    ee = (e, t) => {
    ...
    te = (e, t) => s(t) && "ephox-embed-iri" === t && s(H(e)),
    re = (e, t) =>
          ...
          onSubmit: (t) => {
            ...
            (((e, t, r) => {
              ...
              ((t.embed =
                ...
                t.embed && (e.source === t.source || ((a = t.source), p(q, a)))
                  ? ee(r, t.embed)
                  : K(r, t)
                      .then((e) => {
                        ee(r, e.html);
  ...
  const se = (e) => {
    ...
    he = (e, t) => {
      var o;
      const a = t.attr("data-mce-object"),
        i = document.createElement(a);
      if ("audio" !== a) {
        const e = t.attr("class"),
          o = t.firstChild;
        if (e && -1 !== e.indexOf("mce-preview-object") && o) {
          const e = o.attr("width"),
            t = o.attr("height");
          (r(e) && i.setAttribute("width", e),
            r(t) && i.setAttribute("height", t));
        } else {
          const e = t.attr("width"),
            o = t.attr("height");
          (r(e) && i.setAttribute("width", e),
            r(o) && i.setAttribute("height", o));
        }
      }
      const l = t.attr("style");
      r(l) && i.setAttribute("style", l);
      const c = null !== (o = t.attributes) && void 0 !== o ? o : [];
      let m = c.length;
      for (; m--; ) {
        const e = c[m].name;
        0 === e.indexOf("data-mce-p-") &&
          i.setAttribute(e.substr(11), c[m].value);
      }
      const u = t.attr("data-mce-html");
      r(u) ? (i.innerHTML = unescape(u)) : (i.innerHTML = "\xa0");
      const d = ((e, t) => {
          const r = (0, e.options.get)("xss_sanitization"),
            o = f(e);
          return N(e.schema, { sanitize: r, validate: o }).parse(t);
        })(e, i.outerHTML),
        h = d.getAll(a)[0];
      return s(h) ? (r(u) || h.empty(), n.some(h)) : n.none();
    },
    pe = (e) => (t) => {
      const r = () => {
      ...
      ((e) => {
        (e.on("PreInit", () => {
          ...
          (c("webkitallowfullscreen mozallowfullscreen".split(" "), (e) => {
            ...
            r.addAttributeFilter("data-mce-object", (t) => {
              let r = t.length;
              for (; r--; ) {
                const o = t[r];
                o.parent &&
