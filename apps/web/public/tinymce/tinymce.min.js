...
!(function () {
  ...
  const F = Array.prototype.slice,
    ...
    Ee = (e) => we(e, R),
    _e = (e, t) => (xe(e, t) ? I.from(e[t]) : I.none()),
    xe = (e, t) => ge.call(e, t),
    Se = (e, t) => xe(e, t) && void 0 !== e[t] && null !== e[t],
    ke = (e) => {
  ...
  const $e = (e) => {
    ...
    Ye = (e, t) => qe(e, t, 0),
    Ge = (e, t) => qe(e, t, e.length - t.length),
    Xe = (e) => (t) => t.replace(e, ""),
    Ze = Xe(/^\s+|\s+$/g),
    Qe = Xe(/^\s+/g),
    Je = Xe(/\s+$/g),
  ...
  const Kt = () => Wt(),
    ...
    Xt = window.navigator.userAgent,
    Zt = Kt(),
    Qt = Zt.browser,
    Jt = Zt.os,
    en = Zt.deviceType,
    tn = -1 !== Xt.indexOf("Windows Phone"),
    nn = {
      transparentSrc:
  ...
  const vn = (e, t) => {
    ...
    _n = (e) => e.dom.nodeName.toLowerCase(),
    xn = (e) => e.dom.nodeType,
    Sn = (e) => (t) => xn(t) === e,
    kn = (e) => Nn(e) && Gt(e.dom),
    Nn = Sn(1),
    ...
    Co = (e) => X(e.dom.attributes, (e, t) => ((e[t.name] = t.value), e), {}),
    wo = (e) => {
      ((e.dom.textContent = ""),
        q(Hn(e), (e) => {
          Eo(e);
    ...
    Oo = (e) => {
      ...
      })(mn(t)).fold(() => n.body.contains(t), k(Oo, Xn));
    },
    Bo = (e, t, n) => {
      if (!m(n))
        throw (
  ...
  const Ur = /^[ \t\r\n]*$/,
    ...
    Xr = (e) => qr(e) && e.hasAttribute("data-mce-bogus"),
  ...
  const Cs = (e, t, n, o) =>
      ...
      !((e, t, n) =>
        ...
        !((e, t, n) => {
          ...
          return yr(r, (e) => xe(s, _n(e)), T(Cn, o));
        })(e, t, n))(e, t, n) &&
      (!o.includeZwsp ||
        !((e) => {
    ...
    ws = (e, t, n, o) =>
      ...
      ((e, t) => qr(e) && xe(t.getNonEmptyElements(), e.nodeName))(t, e) ||
      ys(t) ||
      ((e) =>
        qr(e) &&
        "A" === e.nodeName &&
    ...
    _s = (e, t, n) => Es(e, t.dom, { checkRootAsContent: !0, ...n }),
    xs = (e, t, n) => ws(e, t, t, { includeZwsp: vs.includeZwsp, ...n }),
    Ss = (e) => {
      const t = e.toLowerCase();
    ...
    Ls = (e, t, n) => {
      ...
      q(No(n), (t) => {
        er(t, s, a).each((n) => {
          const o = ((t) =>
            Y(Hn(t), (t) => s(t) && !e.isValidChild(_n(n), _n(t))))(t);
          if (o.length > 0) {
            const t = Mn(n);
            (q(o, (t) => {
              er(t, s, a).each((n) => {
    ...
    Us = (e, t) => xe(e.getTransparentElements(), t),
    ...
    Gs = (e, t) => C(e) && (xs(t, e) || t.isInline(e.nodeName.toLowerCase())),
    Xs = (e) =>
    ...
    Ra = (e = {}) => {
      ...
      const c = Na(e.valid_styles),
        ...
        _ = i("move_caret_before_on_enter_elements", w + " table", y),
        x = "h1 h2 h3 h4 h5 h6",
        S = i(
          "text_block_elements",
          x +
    ...
    Ua = (e, t) => {
      const n = null != t ? t : {};
      for (const t in e) xe(Fa, t) || (n[t] = e[t]);
      return (
    ...
    ni = (e, t = {}) => {
      ...
      const a = Ys.forElement(mn(e), {
            ...
            if (((n = n || e), t)) {
              ...
              for (a = t.parentNode; a && a !== n && a.nodeType && !Ws(a, n); )
                ((o -= a.scrollLeft || 0),
                  ...
                  (a = a.parentNode));
              r += ((e) =>
                Vs.isFirefox() && "table" === _n(e)
                  ? qs(Hn(e))
                      .filter((e) => "caption" === _n(e))
                      .bind((e) =>
                        qs(jn(e)).map((t) => {
        ...
        T = (e, t, n, o) => {
          ...
          let s = f(e);
          o = void 0 === o;
          const a = n || ("BODY" !== _().nodeName ? _().parentNode : null);
          if (m(t))
            if ("*" === t) t = qr;
            else {
              const e = t;
        ...
        Y = {
          ...
          events: c,
          isBlock: (e) =>
            m(e) ? xe(u, e) : qr(e) && (xe(u, e.nodeName) || js(l, e)),
          root: null,
          ...
          createHTML: (e, t, n = "") => {
            ...
            for (const e in t)
              Se(t, e) && (o += " " + e + '="' + I(t[e]) + '"');
            return tt(n) && xe(l.getVoidElements(), e)
              ? o + " />"
              : o + ">" + n + "</" + e + ">";
          },
          createFragment: (t) => {
          ...
          const o = t.keep_values,
            ...
            s = {
              style: {
                ...
                get: (t) => {
                  const n = mn(t),
                    o = ho(n, Ga) || ho(n, "style");
                  return e.serialize(e.parse(o), _n(n));
                },
              },
            };
  ...
  class ri {
    ...
    loadScripts(e) {
      const t = this,
        n = (e, n) => {
          (_e(t.scriptLoadedCallbacks, n).each((t) => {
            q(t, (t) => t[e](n));
          }),
    ...
    li = {
      ...
      translate: (e) => {
        const t = ii().getOr({}),
          ...
          r = (e) => {
            const o = n(e);
            return xe(t, o) ? n(t[o]) : _e(t, o.toLowerCase()).map(n).getOr(o);
          },
  ...
  const ci = N("mce-annotation"),
    ...
    ki = _i(["ul", "ol", "dl"]),
    Ni = _i(["li", "dd", "dt"]),
    Ri = _i(["thead", "tbody", "tfoot"]),
    Ai = _i(["td", "th"]),
    Ti = _i(["pre", "script", "textarea", "style"]),
    Oi = () => {
      const e = cn("br");
    ...
    hl = qr,
    bl = fl,
    vl = Gr("display", "block table"),
    yl = Gr("float", "left right"),
    Cl = (
      (...e) =>
      (t) => {
    ...
    wl = O(Gr("white-space", "pre pre-line pre-wrap")),
    El = es,
    _l = as,
    xl = ni.nodeIndex,
  ...
  ((Pl.fromRangeStart = (e) => Pl(e.startContainer, e.startOffset)),
    ...
    (Pl.after = (e) => Pl(e.parentNode, xl(e) + 1)),
    (Pl.before = (e) => Pl(e.parentNode, xl(e))),
    (Pl.isAbove = (e, t) =>
  ...
  const Dl = (e, t) => {
    ...
    Zl = (e, t, n) => {
      ...
      const s = ((e) =>
        Xl(e.startContainer, e.startOffset) || Xl(e.endContainer, e.endOffset))(
        r,
      );
      if (s) {
        const e = s.tagName;
      ...
      (n) => {
        ...
        if (o) {
          if (-1 !== n.indexOf("=")) {
            ...
            return { value: _e(r, e.id).getOr(t), valid: o };
          }
    ...
    Nu = ms,
    Ru = (e, t, n) => {
      const o = Xi(t.getBoundingClientRect(), n);
      let r, s;
      if ("BODY" === e.tagName) {
    ...
    um = (e) =>
      ...
      ((e) =>
        !!gl(e) &&
        !X(ce(e.getElementsByTagName("*")), (e, t) => e || sl(t), !1))(e),
    mm = pl,
    fm = (e, t) =>
  ...
  const qm = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    Gm = (e) => Ym(Km(e.selection.getSel()), mn(e.getBody())),
    Xm = (e, t) => or(e, "table", t),
    ...
    jf = (e, t, n, o = {}) => {
      ...
      return (
        ...
        (_f(m) || m.block_expand) &&
          ((_f(m) && es(l) && 0 !== d) || (l = Uf(e, n, l, d, !0, s)),
          (_f(m) && es(c) && u !== c.data.length) ||
            (c = Uf(e, n, c, u, !1, s))),
        xf(m) &&
    ...
    Kf = (e) => {
      const t = (() => {
        ...
        return {
          ...
          lookup: (t) => _e(e, t).map((e) => e.settings),
          getNames: () => fe(e),
        };
      })();
      ((e, t) => {
  ...
  const Gf = (e, t, n) =>
    ...
    Xf = (e, t) => {
      const n = Rn(t) ? Xo(t).length : Hn(t).length + 1;
      return e > n ? n : e < 0 ? 0 : e;
    },
    Zf = (e) =>
      Tr.range(
        e.start,
        Xf(e.soffset, e.start),
        e.finish,
        Xf(e.foffset, e.finish),
      ),
  ...
  const cg = ni.DOM,
    ...
    kg = (e, t) => {
      ...
      const E = (e) => C(e) && (is(e) || n.is(e, "figure.image")),
        _ = (e) => gs(e) || n.hasClass(e, "mce-preview-object"),
        x = (e) => {
          const n = e.target;
          ((e, t) => {
            if (
              ...
              const n = e.touches[0];
              return E(e.target) && !Gf(n.clientX, n.clientY, t);
            }
            return E(e.target) && !Gf(e.clientX, e.clientY, t);
        ...
        A = (e) => {
          ...
          ((o = e.screenX - u),
            ...
            (C = C > 0 ? C : 0),
            (x = x > 0 ? x : 0),
            n.setStyles(l, { left: C, top: x, display: "block" }),
            (l.innerHTML = b + " &times; " + v),
            (o = s.scrollWidth - y),
            (r = s.scrollHeight - w),
            o + r !== 0 && n.setStyles(l, { left: C - o, top: x - r }),
            h ||
              (((e, t, n, o, r) => {
        ...
        O = (e) => {
          ...
          const h = n.getPos(e, s),
            ...
            N = x.width || x.right - x.left,
            O = x.height || x.bottom - x.top;
          a !== e && (P(), (a = e), (b = v = 0));
      ...
      return (
        t.on("init", () => {
          (I(),
            ...
            t.on("hide blur", P),
            t.on("contextmenu longpress", x, !0));
        }),
        t.on("remove", M),
        {
          isResizable: k,
  ...
  const Ug = (e) => "textarea" === _n(e),
    ...
    Xg = (e, t, n) => jg(e, Yg, t, n),
    Zg = (e, t, n) => Vg(e, t, Yg, n),
    Qg = (e, t, n) => jg(e, Gg, t, n),
    Jg = (e, t, n) => Vg(e, t, Gg, n),
    ep = (e, t, n) => {
      (e.inline ? Xg : Qg)(e, t, n);
    },
    tp = (e, t) =>
      t.collapsed
  ...
  const mp = an.makeMap(
    ...
    Np = (e, t, n) => {
      ...
      return (
        (o =
          "raw" === t.format
            ? an.trim(Li(xp(n, e.serializer.getTempAttrs()).innerHTML))
            : "text" === t.format
              ? ((e, t) => {
                  const n = e.getDoc(),
                    o = Yn(mn(e.getBody())),
  ...
  const Pp = ["font", "text-decoration", "text-emphasis"],
    ...
    ih = (e) => om(e).exists(xi),
    lh = (e, t, n, o) => {
      const r = Y(Qp(mn(n.container()), t), (e) => o.isBlock(_n(e))),
        s = le(r).getOr(t);
      return Cm(e, s.dom, n).filter(ih);
    },
    dh = (e, t, n) => om(t).exists(xi) || lh(!0, e, t, n).isSome(),
    ch = (e, t, n) =>
      ((e) => I.from(e.getNode(!0)).map(mn))(t).exists(xi) ||
      lh(!1, e, t, n).isSome(),
    uh = T(lh, !1),
    mh = T(lh, !0),
    fh = (e) => Pl.isTextPosition(e) && !e.isAtStart() && !e.isAtEnd(),
    gh = (e, t, n) => {
      const o = Y(Qp(mn(t.container()), e), (e) => n.isBlock(_n(e)));
      return le(o).getOr(e);
    },
    ph = (e, t, n) =>
      fh(t) ? Fp(t) : Fp(t) || Sm(gh(e, t, n).dom, t).exists(Fp),
    hh = (e, t, n) =>
      fh(t) ? Ip(t) : Ip(t) || xm(gh(e, t, n).dom, t).exists(Ip),
    bh = (e) =>
      om(e)
        .bind((e) => tr(e, Nn))
        .exists((e) =>
    ...
    _h = (e, t) => $m(e.charAt(t)),
    xh = (e, t) => qm(e.charAt(t)),
    Sh = (e, t, n, o) => {
      const r = t.data,
        s = Pl(t, 0);
      return n || !_h(r, 0) || Eh(e, s, o)
        ? !!(n && xh(r, 0) && Ch(e, s, o)) && ((t.data = it + r.slice(1)), !0)
        : ((t.data = " " + r.slice(1)), !0);
    },
    kh = (e, t, n, o) => {
      const r = t.data,
        s = Pl(t, r.length - 1);
      return n || !_h(r, r.length - 1) || Eh(e, s, o)
        ? !!(n && xh(r, r.length - 1) && wh(e, s, o)) &&
    ...
    Rh = (e, t, n, o) => {
      if (0 === n) return;
      const r = mn(e),
        s = er(r, (e) => o.isBlock(_n(e))).getOr(r),
        ...
        e
          ? ((e, t) =>
              Dh(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    xm(e, Pl.after(t)).orThunk(() => Sm(e, Pl.before(t))))(
                    e,
                    t,
                  ),
                ))(t, n)
    ...
    Ih = (e, t) => t && xe(e.schema.getBlockElements(), _n(t)),
    Fh = (e, t, n, o = !0, r = !1) => {
      ...
      const l = ((e, t, n, o) => {
        ...
        s,
        e.schema,
        ((e, t) => xe(e.schema.getTextInlineElements(), _n(t)))(e, n),
      );
    ...
    Qh = (e, t, n) =>
      ze(km(n), Nm(n), (o, r) => {
        const s = $h(!0, o),
          ...
          i = $h(!1, t);
        return e
          ? xm(n, i).exists((e) => e.isEqual(a) && t.isEqual(s))
          : Sm(n, i).exists((e) => e.isEqual(s) && t.isEqual(a));
      }).getOr(!0),
    Jh = (e) => {
      var t;
      return (8 === xn((t = e)) || "#comment" === _n(t) ? Fn(e) : qn(e))
        .bind(Jh)
        .orThunk(() => I.some(e));
    },
    eb = (e, t, n, o = !0) => {
      ...
      if (
        (a.dom === e.getBody()
          ? Zh(e, o)
          : _s(e.schema, a, { checkRootAsContent: !1 }) &&
        ...
        const t = Fe(Ln(a), n)
          ...
          : Ln((i = a))
              ...
              .getOr([]);
        q(t.concat(Hn(n)), (t) => {
          Cn(t, a) || wn(t, a) || !_s(e.schema, t) || Eo(t);
        });
      }
      var i;
    },
    ...
    ib = (e, t) =>
      Xm(e.start, t).bind((n) => Xm(e.end, t).bind((e) => je(Cn(n, e), n))),
    lb = (e) => (t) =>
      ib(t, e).map((e) =>
        ...
        const e = sb(n.startContainer, o),
          ...
          r = e
            .bind(
              (
                (e) => (t) =>
                  Xm(t, e).bind((e) => de(tb(e)).map((e) => ob(t, e)))
              )(o),
            )
            .bind(lb(o)),
          s = t
            .bind(
              (
                (e) => (t) =>
                  Xm(t, e).bind((e) => le(tb(e)).map((e) => ob(e, t)))
              )(o),
            )
            .bind(lb(o));
    ...
    vb = (e, t, n, o) =>
      I.some(() => {
        ...
        const i = _s(e.schema, s) ? t : t.slice(1),
          l = _s(e.schema, a) ? n : n.slice(0, -1);
        ...
        () =>
          ((e, t, n, o) => {
            ...
            return wb(n, o).bind((o) =>
              _s(e.schema, o, { checkRootAsContent: !1 })
                ? _b(e, o)
                : ((e, t, n, o, r) =>
                    wm(n, e.getBody(), r).bind((e) =>
                      wb(t, mn(e.getNode())).bind((e) =>
                        Cn(e, o) ? I.none() : I.some(x),
                      ),
                    ))(e, n, t, o, r),
            );
          })(e, t, o, n).orThunk(() =>
            je(
              ((e, t) => {
                ...
                return (
                  xb(t, n) || Cm(t, e.getBody(), n).exists((e) => xb(t, e))
                );
              })(e, t),
              x,
            ),
      ...
      (m === f &&
        ...
        s.isCollapsed() ||
          ((e) => {
            ...
            const o = t.getParent(n.startContainer, Gb);
            ((e, t, n) =>
              !!C(n) && n === e.getParent(t.endContainer, Gb) && Jm(mn(n), t))(
              t,
              n,
              o,
            )
          ...
          I.from(e.getParent(t, "td,th"))
            ...
            .each((e) =>
              ((e, t) => {
                qn(e).each((n) => {
                  Fn(n).each((o) => {
                    t.isBlock(_n(e)) && xi(n) && t.isBlock(_n(o)) && Eo(n);
                  });
                });
              })(e, n),
            );
    ...
    wv = (e, t) => {
      ...
      const n = e.schema.getTextInlineElements();
      return xe(n, _n(t)) && !Am(t.dom) && !Xr(t.dom);
    },
    Ev = {},
    _v = Yr(["pre"]);
  ((e) => {
  ...
  const xv = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
    Sv = (e, t) => {
      const n = e.get(t);
      return p(n)
        ? Q(
            ...
            (e) =>
              _f(e) &&
              "span" === e.inline &&
              ((e) => f(e.styles) && $(fe(e.styles), (e) => H(xv, e)))(e),
          )
        : I.none();
    },
    ...
    Nv = (e, t) =>
      !1 ===
      xm(t, Pl.fromRangeEnd(e)).exists(
        (e) => !as(e.getNode()) || xm(t, e).isSome(),
      ),
    Rv = (e) => (t) => ps(t) && e.isEditable(t),
    Av = (e) => Y(e.getSelectedBlocks(), Rv(e.dom)),
    Tv = an.each,
    Ov = (e) => qr(e) && !Hm(e) && !Am(e) && !Xr(e),
    Bv = (e, t) => {
      for (let n = e; n; n = n[t]) {
      ...
      (o || e.selection.isEditable()) &&
        ((e, t, n, o, r) => {
          const s = e.formatter.get(t),
            ...
            u = (t) => {
              const n = ce(t.childNodes),
                o = c(t) || $(s, (e) => sv(i, t, e)),
                r = t.parentNode;
              if ((!o && C(r) && xf(a) && c(r), a.deep && n.length))
          ...
          if (o) {
            ...
            (l.isCollapsed() && _f(a) && !Gm(e).length
              ? vv(e, t, n, r)
              : (af(
                  e,
                  () => nf(e, f),
              ...
              ((e, t, n) => {
                "removeformat" === t
                  ? q(Av(e.selection), (t) => {
                      (q(xv, (n) => e.dom.setStyle(t, n, "")), Gv(e.dom, t));
                    })
                  : Sv(e.formatter, t).each((t) => {
                      q(Av(e.selection), (o) => Xv(e.dom, o, t, n, null));
                    });
              })(e, t, n),
              cd(e, t, o, n));
        })(e, t, n, o, r);
            ...
            q(l, (a) => {
              ...
              (!(l.length > 1) && o.isBlock(a)) || 0 !== i
                ? (_f(s) || (wf(s) && s.wrapper)) &&
                  ...
                  ((e, t, n, o) => {
                    if (_f(t) && ("sub" === t.inline || "sup" === t.inline)) {
    ...
    dy = (e, t) => {
      ...
      return Y(yf(e.dom, n), (e) => qr(e) && !Xr(e));
    },
    cy = (e, t, n) => {
      const o = dy(e, t);
      pe(n, (n, r) => {
  ...
  let vy = 0;
  const yy = (e, t, n) =>
      py(e).bind(({ data: e, type: o, base64Encoded: r }) => {
    ...
    Cy = (e, t, n) => {
      const o = e.create("blobid" + vy++, t, n);
      return (e.add(o), o);
    },
    wy = (e, t, n = !1) =>
      yy(t, n, (t, n) =>
        I.from(e.getByData(t, n)).orThunk(() =>
          hy(n, t).map((n) => Cy(e, n, t)),
        ),
      ),
    Ey =
  ...
  let { freeze: Oy, seal: By, create: Py } = Object,
    { apply: Dy, construct: Ly } = "undefined" != typeof Reflect && Reflect;
  (Oy ||
    (Oy = function (e) {
      return e;
    }),
  ...
  const My = Zy(Array.prototype.forEach),
    Iy = Zy(Array.prototype.lastIndexOf),
    Fy = Zy(Array.prototype.pop),
    Uy = Zy(Array.prototype.push),
    zy = Zy(Array.prototype.splice),
    jy = Zy(String.prototype.toLowerCase),
    Hy = Zy(String.prototype.toString),
    $y = Zy(String.prototype.match),
    Vy = Zy(String.prototype.replace),
    qy = Zy(String.prototype.indexOf),
    Wy = Zy(String.prototype.trim),
    Ky = Zy(Object.prototype.hasOwnProperty),
    Yy = Zy(RegExp.prototype.test),
    Gy =
      ((Xy = TypeError),
      function () {
  ...
  function Qy(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : jy;
    Ny && Ny(e, null);
    let o = t.length;
    for (; o--; ) {
      let r = t[o];
  ...
  function Jy(e) {
    for (let t = 0; t < e.length; t++) Ky(e, t) || (e[t] = null);
    return e;
  }
  function eC(e) {
    const t = Py(null);
    for (const [n, o] of ky(e))
      Ky(e, n) &&
        (Array.isArray(o)
          ? (t[n] = Jy(o))
  ...
  function tC(e, t) {
    for (; null !== e; ) {
      const n = Ty(e, t);
      if (n) {
        if (n.get) return Zy(n.get);
        if ("function" == typeof n.value) return Zy(n.value);
      }
      e = Ay(e);
    }
    return function () {
  ...
  var SC = (function e() {
    ...
    let { IS_ALLOWED_URI: I } = _C,
      F = null;
    const U = Qy({}, [...nC, ...oC, ...rC, ...aC, ...lC]);
    let z = null;
    const j = Qy({}, [...dC, ...cC, ...uC, ...mC]);
    let H = Object.seal(
        Py(null, {
          tagNameCheck: {
            writable: !0,
    ...
    let ce = null;
    const ue = Qy({}, ["audio", "video", "img", "source", "image", "track"]);
    let me = null;
    const fe = Qy({}, [
        "alt",
        "class",
    ...
    let be = he,
      ve = !1,
      ye = null;
    const Ce = Qy({}, [ge, pe, he], Hy);
    let we = Qy({}, ["mi", "mo", "mn", "ms", "mtext"]),
      Ee = Qy({}, ["annotation-xml"]);
    const _e = Qy({}, ["title", "style", "font", "a", "script"]);
    let xe = null;
    ...
    const Re = o.createElement("form"),
          ...
          if (
            ...
            (xe =
              -1 === Se.indexOf(e.PARSER_MEDIA_TYPE)
                ? "text/html"
                : e.PARSER_MEDIA_TYPE),
            (ke = "application/xhtml+xml" === xe ? Hy : jy),
            (F = Ky(e, "ALLOWED_TAGS") ? Qy({}, e.ALLOWED_TAGS, ke) : U),
            (z = Ky(e, "ALLOWED_ATTR") ? Qy({}, e.ALLOWED_ATTR, ke) : j),
            (ye = Ky(e, "ALLOWED_NAMESPACES")
              ? Qy({}, e.ALLOWED_NAMESPACES, Hy)
              : Ce),
            (me = Ky(e, "ADD_URI_SAFE_ATTR")
              ? Qy(eC(fe), e.ADD_URI_SAFE_ATTR, ke)
              : fe),
            (ce = Ky(e, "ADD_DATA_URI_TAGS")
              ? Qy(eC(ue), e.ADD_DATA_URI_TAGS, ke)
              : ue),
            (le = Ky(e, "FORBID_CONTENTS")
              ? Qy({}, e.FORBID_CONTENTS, ke)
              : de),
            ($ = Ky(e, "FORBID_TAGS") ? Qy({}, e.FORBID_TAGS, ke) : eC({})),
            (V = Ky(e, "FORBID_ATTR") ? Qy({}, e.FORBID_ATTR, ke) : eC({})),
            (ie = !!Ky(e, "USE_PROFILES") && e.USE_PROFILES),
            ...
            ie &&
              ((F = Qy({}, lC)),
              (z = []),
              !0 === ie.html && (Qy(F, nC), Qy(z, dC)),
              !0 === ie.svg && (Qy(F, oC), Qy(z, cC), Qy(z, mC)),
              !0 === ie.svgFilters && (Qy(F, rC), Qy(z, cC), Qy(z, mC)),
              !0 === ie.mathMl && (Qy(F, aC), Qy(z, uC), Qy(z, mC))),
            e.ADD_TAGS && (F === U && (F = eC(F)), Qy(F, e.ADD_TAGS, ke)),
            e.ADD_ATTR && (z === j && (z = eC(z)), Qy(z, e.ADD_ATTR, ke)),
            e.ADD_URI_SAFE_ATTR && Qy(me, e.ADD_URI_SAFE_ATTR, ke),
            e.FORBID_CONTENTS &&
              (le === de && (le = eC(le)), Qy(le, e.FORBID_CONTENTS, ke)),
            se && (F["#text"] = !0),
            Z && Qy(F, ["html", "head", "body"]),
            F.table && (Qy(F, ["tbody"]), delete $.tbody),
      ...
      De = function (e, t) {
        try {
          Uy(n.removed, { attribute: t.getAttributeNode(e), from: t });
        } catch (e) {
          Uy(n.removed, { attribute: null, from: t });
        }
      ...
      Le = function (e) {
        ...
        if (be === he)
          try {
            t = new f().parseFromString(r, xe);
          } catch (e) {}
        if (!t || !t.documentElement) {
          t = _.createDocument(be, "template", null);
          try {
    ...
    const ze = function (e) {
        ...
        if (
          ...
          X &&
            ...
            Yy(/<[/\w!]/g, e.innerHTML) &&
            Yy(/<[/\w!]/g, e.textContent))
        )
          return (Pe(e), !0);
        if (7 === e.nodeType) return (Pe(e), !0);
        if (X && 8 === e.nodeType && Yy(/<[/\w]/g, e.data)) return (Pe(e), !0);
        if (!F[o] || $[o]) {
          if (!$[o] && He(o)) {
            if (H.tagNameCheck instanceof RegExp && Yy(H.tagNameCheck, o))
              return !1;
                ...
                : e.namespaceURI === ge
                  ...
                  : e.namespaceURI === he
                    ? !(t.namespaceURI === pe && !Ee[o]) &&
                      ...
                      !Be[n] &&
                      (_e[n] || !Oe[n])
                    : !("application/xhtml+xml" !== xe || !ye[e.namespaceURI]))
            );
          })(e)
          ? (Pe(e), !0)
          : ("noscript" !== o && "noembed" !== o && "noframes" !== o) ||
              !Yy(/<\/no(script|embed|frames)/i, e.innerHTML)
            ? (G &&
                3 === e.nodeType &&
                ((t = e.textContent),
                My([A, T, O], (e) => {
                ...
                e.textContent !== t &&
                  (Uy(n.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
      ...
      $e = function (e) {
        ...
        for (; r--; ) {
          ...
          if (
            ...
            !re ||
              ("id" !== d && "name" !== d) ||
              (De(a, e), (u = "user-content-" + u)),
            X && Yy(/((--!?|])>)|<\/(style|title)/i, u))
          ) {
            De(a, e);
            continue;
          }
    ...
    return (
      (n.sanitize = function (e) {
        ...
        if (
          ...
          if ("function" != typeof e.toString)
            throw Gy("toString is not a function");
          if ("string" != typeof (e = e.toString()))
            throw Gy("dirty is not a string, aborting");
        }
        ...
        return (
          Z &&
            ...
            Yy(wC, o.ownerDocument.doctype.name) &&
      ...
      (n.addHook = function (e, t) {
        "function" == typeof t && Uy(R[e], t);
      }),
      (n.removeHook = function (e, t) {
        if (void 0 !== t) {
          const n = Iy(R[e], t);
          return -1 === n ? void 0 : zy(R[e], n, 1)[0];
        }
        return Fy(R[e]);
      }),
  ...
  class BC {
    ...
    constructor(e, t = {}) {
      ...
      if (
        ...
        const t = n ? n.path : new BC(document.location.href).directory;
    ...
    toRelative(e) {
      if ("./" === e) return e;
      const t = new BC(e, { base_uri: this });
      if (
    ...
    toAbsolute(e, t) {
      const n = new BC(e, { base_uri: this });
  ...
  const MC = (e, t, n, o, r) => {
      ...
      if (!g && m(p)) return void ("all" === p ? Eo(f) : _o(f));
        ...
        if ((C(r) && (r.allowedTags[u] = !0), d && h && !g)) {
          if (
            (q(
              ...
              (e) => {
                go(f, e.name, "{$uid}" === e.value ? "mce_" + LC++ : e.value);
              },
            ),
            q(
    ...
    zC = (e, t, n, o) => {
      ...
      for (let s = r.length - 1; s >= 0; s--) {
        const a = r[s],
          i = a.name,
          l = a.value;
        IC(t, n, o, e.tagName.toLowerCase(), i, l) || FC(e, i)
          ? UC(i, n) && e.setAttribute(i, i)
          : e.removeAttribute(i);
      }
    },
    jC = (e, t, n) => {
    ...
    WC = (e, t, n, o, r) => {
      ...
      for (let t = 0, s = i.length; t < s; t++) {
        const s = i[t],
          l = new up(s.nodeName.toLowerCase(), s.nodeType);
        if (qr(s)) {
          ...
          ks(l.name) && (o(s), (l.value = s.innerHTML));
        } else
          es(s)
            ? ((l.value = s.data), a && (l.raw = !0))
            : os(s)
              ? (l.value = r ? fy(s.data) : s.data)
              : (ts(s) || ns(s)) && (l.value = s.data);
        (ks(l.name) || WC(l, s, n, o, r), e.append(l));
      }
    },
    KC = (e = {}, t = Ra()) => {
      const n = my(),
        ...
        a = ((e, t) => {
          ...
          if (e.sanitize) {
            ...
            return { sanitizeHtmlElement: r, sanitizeNamespaceElement: $C(e) };
          }
          return {
        ...
        g = (e, n) => {
          const o = m(n.attr(DC)),
            r = 1 === n.type && !xe(e, n.name) && !$s(t, n) && !ks(n.name);
          return 3 === n.type || (r && !o);
        },
        p = {
          schema: t,
          ...
          parse: (e, n = {}) => {
            ...
            const i = r.validate,
              ...
              c = ((e, n, o = "html") => {
                const r = "xhtml" === o ? "application/xhtml+xml" : "text/html",
                  i = xe(t.getSpecialElements(), n.toLowerCase()),
                  l = i ? `<${n}>${e}</${n}>` : e,
                  d = s.parseFromString(
                    "xhtml" === o
            ...
            const [f, p] = ((e, t, n, o) => {
                const r = n.validate,
                  ...
                  a = t.getWhitespaceElements(),
                  i = qC(
                    VC("script,style,head,html,body,title,meta,param"),
                    t.getBlockElements(),
                  ),
                  l = ka(t),
                  d = /[ \t\r\n]+/g,
    ...
    ZC = (e, t, n) => {
      ...
      {
        const o = YC(t, (t) => md(e, { ...n, content: t }), GC(e));
        return o.content;
      }
    },
    QC = (e, t) => {
    ...
    ew = (e, t, n) => ({ element: e, width: t, rows: n }),
    tw = (e, t) => ({ element: e, cells: t }),
    nw = (e, t) => ({ x: e, y: t }),
    ow = (e, t) => bo(e, t).bind(nt).getOr(1),
    rw = (e, t, n) => {
      const o = e.rows;
      return !!(o[n] ? o[n].cells : [])[t];
    },
    sw = (e) => X(e, (e, t) => (t.cells.length > e ? t.cells.length : e), 0),
    aw = (e, t) => {
      const n = e.rows;
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++)
          if (Cn(o[n], t)) return I.some(nw(n, e));
      }
      return I.none();
    },
    iw = (e, t, n, o, r) => {
    ...
    dw = (e, t, n) => {
      const o = mn(t.commonAncestorContainer),
        r = Qp(o, e),
        s = Y(r, (e) => n.isWrapper(_n(e))),
        a = ((e, t) =>
          Q(e, (e) => "li" === _n(e) && Jm(e, t)).fold(N([]), (t) =>
            ((e) => Q(e, (e) => "ul" === _n(e) || "ol" === _n(e)))(e)
              .map((e) => {
                const t = cn(_n(e)),
              ...
              aw(e, n).map((n) =>
                ((e, t, n) => {
                  const o = t.x,
                    ...
                    s = n.x,
                    a = n.y,
                    i = r < a ? iw(e, o, r, s, a) : iw(e, o, a, s, r);
                  return ew(e.element, sw(i), i);
                })(e, t, n),
              ),
            ))(r, n, o).map((e) => Yo([lw(e)]));
        })
      ...
      return o.length > 0
        ...
        : ((e, t, n) =>
            t.length > 0 && t[0].collapsed
              ...
              : ((e, t, n) =>
                  ((e, t) => {
                    const n = X(t, (e, t) => (co(t, e), t), e);
                    return t.length > 0 ? Yo([n]) : n;
                  })(mn(t.cloneContents()), dw(e, t, n)))(e, t[0], n))(e, t, n);
    },
    fw = (e, t) => t >= 0 && t < e.length && qm(e.charAt(t)),
    gw = (e) => Li(e.innerText),
    pw = (e) =>
      qr(e)
        ? e.outerHTML
    ...
    hw = (e, t) => (
      ((e, t) => {
        ...
        })(V(ce(t.childNodes), pw), e),
        t,
      ),
      t
    ),
    bw = st(() => document.implementation.createHTMLDocument("undo")),
    vw = (e) => {
      ...
      return ((e) => null !== e.querySelector("iframe"))(n)
        ? {
            type: "fragmented",
            fragments: Y(V(ce(n.childNodes), S(Li, pw)), (e) => e.length > 0),
            content: "",
            bookmark: null,
            beforeBookmark: null,
          }
    ...
    Cw = (e) => ("fragmented" === e.type ? e.fragments.join("") : e.content),
    ww = (e) => {
      const t = cn("body", bw());
      return (Ao(t, Cw(e)), q(vr(t, "*[data-mce-bogus]"), _o), Ro(t));
    },
    Ew = (e, t) =>
      !(!e || !t) &&
      (!!((e, t) => Cw(e) === Cw(t))(e, t) ||
    ...
    kw = (e) => ({
      ...
      undoManager: {
        beforeChange: (t, n) =>
          ((e, t, n) => {
            _w(t) && n.set(ed(e.selection));
          })(e, t, n),
        add: (t, n, o, r, s, a) =>
          ((e, t, n, o, r, s, a) => {
            const i = vw(e),
              l = an.extend(s || {}, i);
            if (!_w(o) || e.removed) return null;
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !Ew(vw(e), t.data[0])))(
            e,
            t,
            n,
          ),
                  ...
                  return ((e) =>
                    I.from(e.selection.getRng())
                      .map((t) => {
                        ...
                        if (
                          (e.dom.remove(i), fw(d, 0) || fw(d, d.length - 1))
                        ) {
                          const e = o.getOr(r),
                            t = gw(e),
                            n = t.indexOf(l);
                      ...
                      .getOr(""))(e);
                {
                  const n = ((e, t) => {
                    const n = e.selection.getRng(),
                      ...
                      s = ap(e, Km(r)),
                      a = t.contextual
                        ? mw(mn(e.getBody()), s, e.schema).dom
                        : n.cloneContents();
                    return (
                      a && o.appendChild(a),
    ...
    Nw = (e) => xe(e.plugins, "rtc"),
    Rw = (e) => (e.rtcInstance ? e.rtcInstance : kw(e)),
    Aw = (e) => {
      const t = e.rtcInstance;
      if (t) return t;
      throw new Error("Failed to get RTC instance not yet initialized.");
    },
    Tw = (e) => Aw(e).init.bindEvents(),
    Ow = (e) => (0 === e.dom.length ? (Eo(e), I.none()) : I.some(e)),
    Bw = (e, t, n, o, r) => {
      e.bind(
        (e) => (
  ...
  const Dw = (e) => !(!e || !e.ownerDocument) && wn(mn(e.ownerDocument), mn(e)),
    Lw = (e, t, n, o) => {
      let r, s;
      const { selectorChangedWithUnbind: a } = ((e, t) => {
          ...
          ((e, t, n = {}) => {
            ...
            QC(e, o).each((t) => {
              ...
              (((e, t, n) => {
                ...
                const s = o.bind(Fn).filter(Rn).bind(Ow),
                  a = r.bind(Un).filter(Rn).bind(Ow);
        ...
        u = (e, t) => {
          if (!((e) => !!e && Dw(e.startContainer) && Dw(e.endContainer))(e))
            return;
          const n = d();
          if (
    ...
    $w = [{ name: "export", replacedWith: "Export to PDF" }],
    Vw = (e, t) => {
      const n = Y(t, (t) => xe(e, t));
      return ae(n);
    },
    qw = (e) => {
      const t = Vw(e, zw),
    ...
    Zw = ni.DOM,
    Qw = (e) => I.from(e).each((e) => e.destroy()),
    Jw = (() => {
      const e = {};
      return {
        add: (t, n) => {
    ...
    eE = di.ModelManager,
    tE = (e, t) => t.dom[e],
    nE = (e, t) => parseInt(Lo(t, e), 10),
    oE = T(tE, "clientWidth"),
    rE = T(tE, "clientHeight"),
    sE = T(nE, "margin-top"),
    aE = T(nE, "margin-left"),
    iE = (e) => {
      const t = [],
    ...
    yE = (e) => {
      const t = mn(e.getBody());
      (bE(t, "mce-content-readonly", !1),
        e.hasEditableRoot() && hr(t, !0),
        ((e, t) => {
          (hE(e, "StyleWithCSS", t),
            hE(e, "enableInlineTableEditing", t),
            hE(e, "enableObjectResizing", t));
        })(e, !1),
        yg(e) && e.focus(),
        ((e) => {
    ...
    _E = (e) => {
      (e.parser.addAttributeFilter("contenteditable", (t) => {
        CE(e) &&
          q(t, (e) => {
            (e.attr(wE, e.attr("contenteditable")),
              e.attr("contenteditable", "false"));
          });
      }),
        e.serializer.addAttributeFilter(wE, (t) => {
          CE(e) &&
            q(t, (e) => {
              e.attr("contenteditable", e.attr(wE));
            });
        }),
        e.serializer.addTempAttr(wE));
    },
    xE = ["copy"],
    SE = (e) => "content/" + e + "/content.css",
    kE = (e, t) => {
      const n = e.editorManager.baseURL + "/skins/content",
        o = `content${e.editorManager.suffix}.css`;
      return V(t, (t) =>
        ((e) => tinymce.Resource.has(SE(e)))(t)
          ? t
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        Ye(o, "blob:")
                          ...
                          by(t).then((o) =>
                            yy(o, !1, (n) => I.some(Cy(e, t, n))).getOrThunk(n),
                          ),
                        );
                  }
                  var o, r;
                  return Ye(t, "data:")
                    ? wy(e, t).fold(n, (e) => Promise.resolve(e))
  ...
  const TE = (e, t) => {
                            ...
                            (Eo(n),
                              o.each(
                                ((e) => (t) => {
                                  ((e, t) =>
                                    e.dom.isEmpty(t.dom) &&
                                    C(e.schema.getTextBlockElements()[_n(t)]))(
                                    e,
                                    t,
    ...
    DE = { remove_similar: !0, inherit: !1 },
    LE = { selector: "td,th", ...DE },
    ME = {
      tablecellbackgroundcolor: {
        styles: { backgroundColor: "%value" },
        ...LE,
      },
      tablecellverticalalign: { styles: { "vertical-align": "%value" }, ...LE },
      tablecellbordercolor: { styles: { borderColor: "%value" }, ...LE },
      tablecellclass: { classes: ["%value"], ...LE },
      tableclass: { selector: "table", classes: ["%value"], ...DE },
      tablecellborderstyle: { styles: { borderStyle: "%value" }, ...LE },
      tablecellborderwidth: { styles: { borderWidth: "%value" }, ...LE },
    },
    IE = N(ME),
    FE = an.each,
    UE = ni.DOM,
    ...
    jE = (e, t) => {
      const n = (t && t.schema) || Ra({}),
        o = (e) => {
          ...
          return (
            ((e, t) => {
              (t.classes.length > 0 && UE.addClass(e, t.classes.join(" ")),
                UE.setAttribs(e, t.attrs));
            })(n, t),
            n
          );
        },
        r = (e, t, s) => {
          ...
          const u = zE(a) ? a.siblings : void 0;
          return r(c, t, u);
        },
        s = UE.create("div");
      if (e.length > 0) {
    ...
    $E = (e, t) => {
      ...
      const r = (e) => (m(e) ? e.replace(/%(\w+)/g, "") : ""),
        s = (t, n) => UE.getStyle(null != n ? n : e.getBody(), t, !0);
      if (m(t)) {
        const n = e.formatter.get(t);
        if (!n) return "";
        t = n[0];
      ...
      var d;
      l.length > 0
        ? (l[0].name || (l[0].name = i), (i = t.selector), (a = jE(l, e)))
        : (a = jE([i], e));
      const c = UE.select(i, a)[0] || a.firstChild;
      (FE(t.styles, (e, t) => {
        const n = r(e);
        n && UE.setStyle(c, t, n);
      }),
        FE(t.attributes, (e, t) => {
          const n = r(e);
          n && UE.setAttrib(c, t, n);
        }),
        FE(t.classes, (e) => {
          const t = r(e);
          UE.hasClass(c, t) || UE.addClass(c, t);
        }),
        e.dispatch("PreviewFormats"),
        UE.setStyles(a, { position: "absolute", left: -65535 }),
                  ...
                  ? (p(o) || (o = [o]),
                    q(o, (e) => {
                      (v(e.deep) && (e.deep = !Ef(e)),
                        v(e.split) && (e.split = !Ef(e) || _f(e)),
                        v(e.remove) && Ef(e) && !_f(e) && (e.remove = "none"),
                        Ef(e) &&
                          _f(e) &&
    ...
    GE = (e) => "keydown" === e.type || "keyup" === e.type,
    XE = (e) => {
      const t = e.keyCode;
    ...
    e_ = (e, t) => {
      const n = ((e, t) => {
        const n = Hn(e);
        return J(n, (e) => t.isBlock(_n(e))).fold(N(n), (e) => n.slice(0, e));
      })(e, t);
      return (q(n, Eo), n);
    },
    t_ = (e, t, n) => {
      const o = Qp(n, t);
      return Q(o.reverse(), (t) => _s(e, t)).each(Eo);
    },
    n_ = (e, t, n, o, r) => {
      if (_s(o, n)) return (Bi(n), km(n.dom));
      ((e, t) => 0 === Y(zn(t), (t) => !_s(e, t)).length)(o, r) &&
        _s(o, t) &&
        ao(r, cn("br"));
          ...
          const e = (e) => {
              const t = (e, n) =>
                Vn(e).fold(
                  () => n,
                  (e) =>
                    ((e, t) => e.isInline(_n(t)))(o, e)
                      ? t(e, n.concat(So(e)))
                      : n,
                );
              return t(e, []);
            },
            r = G(e(n), (e, t) => (uo(e, t), t), Oi());
          (wo(t), co(t, r));
        }
    ...
    s_ = (e, t, n, o) => (
      ...
      ((e, t) =>
        wn(t, e)
          ...
          : I.none())(t, n).fold(T(o_, e, t, n, o), T(n_, e, t, n, o))
    ),
    a_ = (e, t, n, o, r) => (t ? s_(e, o, n, r) : s_(e, n, o, r)),
    i_ = (e, t) => {
      const n = mn(e.getBody()),
        o = ((e, t, n, o) =>
          o.collapsed
            ? ((e, t, n, o) => {
                const r = QE(t, Pl.fromRangeStart(o)),
                  s = r.bind((o) =>
                    Cm(n, t, o.position).bind((o) =>
                      QE(t, o).map((o) =>
                        ((e, t, n, o) =>
                          as(o.position.getNode()) && !_s(e, o.block)
                            ? _m(!1, o.block.dom)
                                .bind((e) =>
                                  e.isEqual(o.position)
                                    ? Cm(n, t, e).bind((e) => QE(t, e))
                                    : I.some(o),
                                )
                                .getOr(o)
                            : o)(e, t, n, o),
                ...
                return ze(r, s, ZE).filter(
                  (e) =>
                    ((e) => !Cn(e.from.block, e.to.block))(e) &&
                    ((e, t) => {
                      const n = mn(e);
                      return Cn(JE(n, t.from.block), JE(n, t.to.block));
                    })(t, e) &&
                    ((e) =>
          ...
          (o) => () => {
            a_(n, t, o.from.block, o.to.block, e.schema).each((t) => {
    ...
    d_ = (e) => {
      ...
      return ((e, t) => {
        const n = Sm(e.dom, Pl.fromRangeStart(t)).isNone(),
          o = xm(e.dom, Pl.fromRangeEnd(t)).isNone();
        return (
          !((e, t) => l_(e, t.startContainer) || l_(e, t.endContainer))(e, t) &&
          n &&
          o
        );
        ...
        : ((e, t, n) => {
            const o = t.getRng();
            return ze(
              Xh(e, mn(o.startContainer)),
              Xh(e, mn(o.endContainer)),
              (r, s) =>
                Cn(r, s)
                  ? I.none()
                  : I.some(() => {
    ...
    c_ = (e, t) => (e.selection.isCollapsed() ? I.none() : d_(e)),
    u_ = (e, t, n, o, r) => I.from(t._selectionOverrides.showCaret(e, n, o, r)),
    m_ = (e, t) =>
      ...
      t.collapsed
        ? ((e, t, n) => {
            const o = em(1, e.getBody(), t),
              ...
              s = r.getNode();
            if (Ou(s)) return u_(1, e, s, !r.isAtEnd(), !1);
            const a = r.getNode(!0);
            if (Ou(a)) return u_(1, e, a, !1, !1);
            const i = Nb(e.dom.getRoot(), r.getNode());
            return Ou(i) ? u_(1, e, i, !1, n) : I.none();
          })(e, t, n).getOr(t)
        : t,
    g_ = (e) => Gp(e) || qp(e),
    p_ = (e) => Xp(e) || Wp(e),
    h_ = (e, t, n, o, r, s) => {
      (u_(o, e, s.getNode(!r), r, !0).each((n) => {
        if (t.collapsed) {
    ...
    b_ = (e, t) =>
      ((e, t) => {
        ...
        if (a(d)) return I.some(() => h_(e, n, i.getNode(), o, t, d));
        const c = s(d);
        return c && a(c) && sm(d, c)
          ? I.some(() => h_(e, n, i.getNode(), o, t, c))
          : I.none();
      })(e, t),
    v_ = (e, t) => {
      const n = e.getBody();
      return t ? km(n).filter(Gp) : Nm(n).filter(Xp);
    },
    y_ = (e) => {
      const t = e.selection.getRng();
      return (
        !t.collapsed &&
        (v_(e, !0).exists((e) => e.isEqual(Pl.fromRangeStart(t))) ||
          v_(e, !1).exists((e) => e.isEqual(Pl.fromRangeEnd(t))))
      );
    },
    C_ = ke([
      { remove: ["element"] },
        ...
        return (
          ...
          ((e, t, n, o, r) => {
            ...
            : (t && cs(r.getNode())) || (!t && cs(r.getNode(!0)))
              ? ((e, t, n, o, r) => {
                  const s = r.getNode(!n);
                  return Xh(mn(t), mn(o.getNode()))
                    .map((t) =>
                      _s(e, t) ? C_.remove(t.dom) : C_.moveToElement(s),
                    )
                    .orThunk(() => I.some(C_.moveToElement(s)));
                })(o, e, t, n, r)
              : (t && Xp(n)) || (!t && Gp(n))
                ? I.some(C_.moveToPosition(r))
                : I.none()
        );
        var s;
      }),
    E_ = (e, t) => I.from(Nb(e.getBody(), t)),
    __ = (e, t) => {
          ...
          () =>
            ((e, t, n, o) => {
              const r = em(t ? 1 : -1, e, n),
                ...
                a = mn(e);
              return !t && Xp(s)
                ? I.some(C_.remove(s.getNode(!0)))
                : t && Gp(s)
                  ? I.some(C_.remove(s.getNode()))
                  : !t && Gp(s) && ch(a, s, o)
                    ? uh(a, s, o).map((e) => C_.remove(e.getNode()))
                    : t && Xp(s) && dh(a, s, o)
                      ? mh(a, s, o).map((e) => C_.remove(e.getNode()))
                      : ((e, t, n, o) =>
                          ((e, t) => {
                            const n = t.getNode(!e),
                              o = e ? "after" : "before";
                            ...
                            ? ((e, t) =>
                                y(t)
                                  ? I.none()
                                  : e && cs(t.nextSibling)
                                    ? I.some(C_.moveToElement(t.nextSibling))
                                    : !e && cs(t.previousSibling)
                                      ? I.some(
                                          C_.moveToElement(t.previousSibling),
                                        )
                            ...
                            : w_(e, t, n, o).bind((t) =>
                                ((e, t, n) =>
                                  n.fold(
                                    (e) => I.some(C_.remove(e)),
                                    (e) => I.some(C_.moveToElement(e)),
                                    (n) =>
                                      Ku(t, n, e)
                                        ? I.none()
                                        : I.some(C_.moveToPosition(n)),
                                  ))(e, n, t),
                              ))(e, t, s, o);
    ...
    k_ = (e) => e.hasOwnProperty("text"),
    N_ = (e) => e.hasOwnProperty("marker"),
    R_ = (e, t) => {
      const n = (e, n) => {
    ...
    O_ = (e, t) =>
      e.selection.isCollapsed()
        ...
        : I.none(),
    B_ = es,
    P_ = (e) => B_(e) && e.data[0] === Pi,
    D_ = (e) => B_(e) && e.data[e.data.length - 1] === Pi,
    L_ = (e) => {
      var t;
      return (
    ...
    M_ = (e, t) =>
      e
        ? ((e) => {
            var t;
            if (B_(e.previousSibling))
              return (
                D_(e.previousSibling) || e.previousSibling.appendData(Pi),
                e.previousSibling
              );
            if (B_(e)) return (P_(e) || e.insertData(0, Pi), e);
            {
              const n = L_(e);
              return (
                null === (t = e.parentNode) ||
        ...
        : ((e) => {
            ...
            if (B_(e.nextSibling))
              return (
                P_(e.nextSibling) || e.nextSibling.insertData(0, Pi),
                e.nextSibling
              );
            if (B_(e)) return (D_(e) || e.appendData(Pi), e);
            {
              const o = L_(e);
              return (
                e.nextSibling
    ...
    F_ = T(M_, !1),
    U_ = (e, t) =>
      es(e.container()) ? M_(t, e.container()) : M_(t, e.getNode()),
    z_ = (e, t) => {
      const n = t.get();
    ...
    W_ = (e, t) => null === Tm(e, t),
    K_ = (e, t, n) => Hh(e, t, n).filter(T(W_, t)),
    Y_ = (e, t, n) => {
      const o = qh(n);
      return K_(e, t, o).bind((e) =>
        Sm(e, o).isNone() ? I.some($_.start(e)) : I.none(),
      );
    },
    G_ = (e, t, n) => {
      const o = Vh(n);
      return K_(e, t, o).bind((e) =>
        xm(e, o).isNone() ? I.some($_.end(e)) : I.none(),
      );
    },
    X_ = (e, t, n) => {
      const o = qh(n),
    ...
    Z_ = (e) => !jh(J_(e)),
    Q_ = (e, t, n) => H_([q_, Y_, G_, X_], [e, t, n]).filter(Z_),
    J_ = (e) => e.fold(R, R, R, R),
    ex = (e) => e.fold(N("before"), N("start"), N("end"), N("after")),
    tx = (e) => e.fold($_.before, $_.before, $_.after, $_.after),
    nx = (e) => e.fold($_.start, $_.start, $_.end, $_.end),
    ox = (e, t, n, o, r, s) =>
    ...
    rx = (e, t) =>
      e.fold(M, (e) => {
        return ((o = t), !(ex((n = e)) === ex(o) && J_(n) === J_(o)));
        var n, o;
      }),
    sx = (e, t) =>
      e
        ? t.fold(S(I.some, $_.start), I.none, S(I.some, $_.after), I.none)
        : t.fold(I.none, S(I.some, $_.before), I.none, S(I.some, $_.end)),
    ax = (e, t, n) => {
      const o = e ? 1 : -1;
      return (
  ...
  const lx = (e, t) => (-1 === e ? oe(t) : t),
    dx = (e, t, n) => (1 === e ? t.next(n) : t.prev(n)),
    cx = (e, t, n, o) =>
      as(o.getNode(1 === t)) ? ix.Br : !1 === Ku(n, o) ? ix.Block : ix.Wrap,
    ux = (e, t, n, o) => {
      const r = hm(n);
      let s = o;
      const a = [];
      for (; s; ) {
        ...
        if (as(n.getNode(!1)))
          return 1 === t
            ? {
                positions: lx(t, a).concat([n]),
                breakType: ix.Br,
                breakAt: I.some(n),
              }
            : { positions: lx(t, a), breakType: ix.Br, breakAt: I.some(n) };
        if (n.isVisible()) {
          if (e(s, n)) {
            const e = cx(0, t, s, n);
      ...
      return { positions: lx(t, a), breakType: ix.Eol, breakAt: I.none() };
    },
    mx = (e, t, n, o) =>
      t(n, o)
        .breakAt.map((o) => {
    ...
    gx = (e, t) => le(t.getClientRects()).bind((t) => fx(e, t.left)),
    px = T(ux, Pl.isAbove, -1),
    hx = T(ux, Pl.isBelow, 1),
    bx = T(mx, -1, px),
    vx = T(mx, 1, hx),
    yx = (e, t) => px(e, t).breakAt.isNone(),
    Cx = (e, t) => hx(e, t).breakAt.isNone(),
    wx = (e, t) => gx(bx(e, t), t),
    Ex = (e, t) => gx(vx(e, t), t),
    _x = cs,
    xx = (e, t) => Math.abs(e.left - t),
    Sx = (e, t) => Math.abs(e.right - t),
    kx = (e, t) =>
      pt(e, (e, n) => {
        const o = Math.min(xx(e, t), Sx(e, t)),
          r = Math.min(xx(n, t), Sx(n, t));
        return (r === o && Se(n, "node") && _x(n.node)) || r < o ? n : e;
      }),
    Nx = (e) => {
      const t = (t) =>
        V(t, (t) => {
  ...
  const Tx = (e, t, n, o, r, s) => {
    ...
    Fx = (e, t, n, o, r, s) => {
      ...
      if (d(c)) return m_(e, c.getNode(!a));
      let u = l(c);
      const m = Ki(n);
      if (!u) return m ? I.some(n) : I.none();
      if (((u = $h(a, u)), d(u))) return u_(t, e, u.getNode(!a), a, !1);
      const f = l(u);
      return f && d(f) && sm(u, f)
        ? u_(t, e, f.getNode(!a), a, !1)
        : m
          ? Ix(e, u.toRange(), !1)
          : I.none();
    },
    Ux = (e, t, n, o, r, s) => {
      ...
      if (((g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : tl(n)), g)) {
        ...
        let o = kx(Y(n, Lx(1)), m);
        if (o) return Ix(e, o.position.toRange(), !1);
        if (((o = bt(Y(n, Lx(0)))), o)) return Ix(e, o.position.toRange(), !1);
      }
      return 0 === u.length
        ? zx(e, l)
            .filter(l ? r : o)
            .map((t) => f_(e, t.toRange(), !1))
        : I.none();
    },
    zx = (e, t) => {
      const n = e.selection.getRng(),
    ...
    Vx = (e, t, n) => j_(t, n).map((t) => (Hx(e, t), n)),
    qx = (e, t, n) => {
      const o = e.getBody(),
        r = ((e, t, n) => {
          ...
          if (e.collapsed) return o;
          {
            ...
            return n ? Sm(t, r).getOr(r) : xm(t, o).getOr(o);
          }
      ...
      })(n, T(zh, e), o, r).bind((n) => Vx(e, t, n));
    },
    Wx = (e, t, n) => !!uc(e) && qx(e, t, n).isSome(),
    Kx = (e, t, n) =>
      !!uc(t) &&
      ((e, t) => {
            ...
            ((e, t, n, o) => {
              if (t.selection.isCollapsed()) {
                ...
                q(r, (o) => {
                  ...
                  Q_(e, t.getBody(), r).bind((e) => Vx(t, n, e));
                });
              }
            })(n, e, t, o.parents));
        }),
    ...
    Zx = (e, t, n) => {
      if (uc(e)) {
        const o = zx(e, t).getOrThunk(() => {
          const n = e.selection.getRng();
          return t ? Pl.fromRangeEnd(n) : Pl.fromRangeStart(n);
        });
        return Q_(T(zh, e), e.getBody(), o).exists((t) => {
          const o = tx(t);
          return j_(n, o).exists((t) => (Hx(e, t), !0));
        });
      }
      return !1;
    },
    Qx = (e, t) => (n) => j_(t, n).map((t) => () => Hx(e, t)),
    Jx = (e, t, n, o) => {
      const r = e.getBody(),
        s = T(zh, e);
      (e.undoManager.ignore(() => {
        (e.selection.setRng(
          ...
          Kh(e),
          Q_(s, r, Pl.fromRangeStart(e.selection.getRng()))
            .map(nx)
            .bind(Qx(e, t))
            .each(D));
      }),
      ...
      if (e.selection.isCollapsed() && uc(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind((e) =>
              n
                ? e.fold(N(I.some(nx(e))), I.none, N(I.some(tx(e))), I.none)
                : e.fold(I.none, N(I.some(tx(e))), I.none, N(I.some(nx(e)))),
            )
            .map(Qx(e, t))
            .getOrThunk(() => {
              const i = wm(n, r, o),
                ...
                Hh(s, r, o).bind((t) =>
                  ((e) =>
                    ze(km(e), Nm(e), (t, n) => {
                      const o = $h(!0, t),
                        r = $h(!1, n);
                      return xm(e, o).forall((e) => e.isEqual(r));
                    }).getOr(!0))(t)
                    ? I.some(() => {
                        Fh(e, n, mn(t));
                      })
    ...
    rS = (e) => {
      const t = ((e) => tS(e, (t) => e.schema.isBlock(_n(t))))(e);
      return oS(e, t);
    },
    sS = (e, t) => {
      const n = Y(
        ((e) => tS(e, (t) => e.schema.isBlock(_n(t)) || ((e) => Wn(e) > 1)(t)))(
          e,
        ),
        nS,
      );
    ...
    iS = (e) => es(e.startContainer),
    lS = (e) => {
      const t = e.selection.getRng();
      return (
        ((e) => 0 === e.startOffset && iS(e))(t) &&
        ((e, t) => {
    ...
    cS = (e) => (
      ((e) => {
        ...
        return (
          t.collapsed &&
          (iS(t) || e.dom.isEmpty(t.startContainer)) &&
          !((e) => {
            return (
      ...
      e.selection.isCollapsed()
        ? ((e, t) => {
            ...
            return n(o)
              ...
              : I.from($h(t, o))
                  .filter((e) => n(e) && sm(o, e))
                  .bind((n) => uS(e, t, n.getNode(!t)));
          })(e, t)
        : ((e, t) => {
            const n = e.selection.getNode();
            return gs(n) ? uS(e, t, n) : I.none();
          })(e, t),
    fS = (e) => nt(null != e ? e : "").getOr(0),
    gS = (e, t) =>
      (e || "table" === _n(t) ? "margin" : "padding") +
    ...
    CS = (e) => {
      if (e.selection.isCollapsed() && pS(e)) {
        ...
        if (null !== r && oh(mn(r), o, e.schema)) return I.some(() => yS(e));
      }
      return I.none();
    },
    wS = (e, t, n) =>
      ue([CS, S_, b_, (e, n) => eS(e, t, n), i_, kb, O_, mS, c_, dS, T_], (t) =>
        t(e, n),
    ...
    ES = (e) =>
      void 0 === e.touches || 1 !== e.touches.length
        ? I.none()
        : I.some(e.touches[0]),
    _S = (e, t) => xe(e, t.nodeName),
    xS = (e, t) =>
      !!es(t) ||
      (!!qr(t) && !(_S(e.getBlockElements(), t) || Hm(t) || js(e, t) || Ns(t))),
    SS = (e, t) => {
      if (es(t)) {
        if (0 === t.data.length) return !0;
        if (/^\s+$/.test(t.data))
          return !t.nextSibling || _S(e, t.nextSibling) || Ns(t.nextSibling);
      }
      return !1;
    },
    kS = (e) => e.dom.create(Ad(e), Td(e)),
    NS = (e, t, n) => {
      const o = mn(kS(e)),
        r = Oi();
      (co(o, r), n(t, o));
    ...
    RS = (e) => (t) => -1 !== (" " + t.attr("class") + " ").indexOf(e),
    AS = (e, t, n) =>
      function (o) {
        const r = arguments,
          s = r[r.length - 2],
    ...
    BS = (e, t) => {
      ...
      if (n)
        return "compositionstart" === t.type
          ? (t.preventDefault(), t.stopPropagation(), void OS(e, n))
          : void (ji(n) && (OS(e, n), e.undoManager.add()));
    },
    PS = cs,
    DS = (e, t, n) => {
    ...
    LS = (e, t) =>
      ((e, t) => {
        const n = t ? 1 : -1,
          o = e.selection.getRng();
        return ((e, t, n) => Fx(t, e, n, Gp, Xp, PS))(n, e, o).orThunk(
          () => (DS(e, n, o), I.none()),
        );
      })(
        e,
      ...
      ((e, t) => {
        ...
        return ((e, t, n) =>
          Ux(
            ...
            (e) => Xp(e) || Yp(e),
            PS,
          ))(n, e, o).orThunk(() => (DS(e, n, o), I.none()));
      })(e, t).exists((t) => (Mx(e, t), !0)),
    IS = (e, t) => jx(e, t, t ? Xp : Gp),
    FS = (e, t) =>
      v_(e, !t)
        .map((n) => {
          const o = n.toRange(),
    ...
    zS = (e, t) =>
      ...
      ((e, t) => {
        ...
        return ((e, t, n) => {
          const o = T(Cn, t);
          return tr(mn(e.container()), (e) => n.isBlock(_n(e)), o).filter(US);
        })(o, n, e.schema).exists(() => {
          if (((e, t, n) => (t ? Cx(e.dom, n) : yx(e.dom, n)))(n, t, o)) {
            const o = NS(e, n, t ? co : lo);
      ...
      ((e, t) =>
        t
          ...
          : I.from(e.dom.getParent(e.selection.getNode(), "summary"))
              ...
              .getOr(!1))(e, t),
    HS = { shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0 },
    $S = (e, t) =>
      t.keyCode === e.keyCode &&
    ...
    KS = (e, t) => {
      const n = t ? 1 : -1,
        o = e.selection.getRng();
      return Fx(e, n, o, qp, Wp, gs).exists((t) => (Mx(e, t), !0));
    },
    YS = (e, t) => {
      const n = t ? 1 : -1,
        o = e.selection.getRng();
      return Ux(e, n, o, qp, Wp, gs).exists((t) => (Mx(e, t), !0));
    },
    GS = (e, t) => jx(e, t, t ? Wp : qp),
    XS = (e, t, n) =>
    ...
    JS = { ...QS, none: (e) => QS.none(e) },
    ek = (e, t, n, o, r = M) => {
      const s = 1 === o;
      if (!s && n <= 0) return JS.first(e[0]);
      if (s && n >= e.length - 1) return JS.last(e[e.length - 1]);
      {
        const s = n + o,
          a = e[s];
        return r(a) ? JS.middle(t, a) : ek(e, t, s, o, r);
      }
    },
    tk = (e, t) =>
      ZS(e, t).bind((t) => {
    ...
    lk = (e) => {
      const t = e;
      return I.from(t[ok]).exists((e) => 0 === e);
    };
  const dk = De("mode"),
    ck = (e) => (t) => {
      t[dk] = e;
    ...
    pk = (e) => (t) => {
      const n = t;
      return I.from(n[dk]).exists((t) => t === e);
    },
    hk = pk(0),
    bk = pk(1),
    vk = ["none", "copy", "link", "move"],
    yk = [
      "none",
      "copy",
      "copyLink",
    ...
    Sk = (e, t, n) => {
      const o = e(t, n);
      return ((e) => e.breakType === ix.Wrap && 0 === e.positions.length)(o) ||
        (!as(n.getNode()) &&
          ((e) => e.breakType === ix.Br && 1 === e.positions.length)(o))
    ...
    Rk = (e, t, n, o) => {
      ...
      return !(
        ...
        !((e, t, n) => {
          ...
          return _m(!e, n).exists((e) => e.isEqual(o));
        })(t, r, n) ||
        (u_(s, e, n, !t, !1).each((t) => {
          Mx(e, t);
        }),
    ...
    Tk = (e, t, n, o) => {
      ...
      if (!t && kk(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            le(t.getClientRects())
              .bind((t) => _k(e, t.left, t.top))
              .bind((e) => {
                return gx(
                  Nm((n = e))
                    .map((e) => px(n, e).positions.concat(e))
                    .getOr([]),
                  t,
                );
                var n;
          ...
          ((e, t) =>
            de(t.getClientRects())
              ...
              .bind((e) => {
                return gx(
                  km((n = e))
                    .map((e) => [e].concat(hx(n, e).positions))
                    .getOr([]),
                  t,
                );
                var n;
    ...
    Dk = (e, t, n) =>
      n.fold(
        ...
        (n) =>
          e.mode.isReadOnly() || !Lk(n)
            ? I.none()
            : (e.execCommand("mceTableInsertRowAfter"), Mk(e, t, n)),
      ),
    Lk = (e) => tr(e, On("table")).exists(gr),
    Mk = (e, t, n) => {
      return Dk(
        e,
        t,
    ...
    jk = (e, t) => ({ container: e, offset: t }),
    Hk = ni.DOM,
    $k = (e) => (t) => (e === t ? -1 : 0),
    Vk = (e, t, n) => {
      if (es(e) && t >= 0) return I.some(jk(e, t));
      {
        const o = Ei(Hk);
        return I.from(o.backwards(e, t, $k(e), n)).map((e) =>
          jk(e.container, e.container.data.length),
        );
      }
    },
    qk = (e, t, n) => {
      ...
      const o = e.data;
      if (t >= 0 && t <= o.length) return I.some(jk(e, t));
      {
        const o = Ei(Hk);
        return I.from(o.backwards(e, t, $k(e), n)).bind((e) => {
    ...
    Wk = (e, t, n) => {
      if (!es(e)) return I.none();
      const o = e.data;
      if (t <= o.length) return I.some(jk(e, t));
      {
        const r = Ei(Hk);
        return I.from(r.forwards(e, t, $k(e), n)).bind((e) =>
          Wk(e.container, t - o.length, n),
        );
      }
    },
    Kk = (e, t, n, o, r) => {
    ...
    Xk = (e, t, n, o = !1) => {
      ...
      return Kk(
        ...
        return 0 !== r.lastIndexOf(n)
          ? I.none()
          : I.some({ text: Gk(r, n), range: o, trigger: n });
      });
    },
    Zk = (e) => {
      if (((e) => 3 === e.nodeType)(e)) return jk(e, e.data.length);
      {
        const t = e.childNodes;
        return t.length > 0 ? Zk(t[t.length - 1]) : jk(e, t.length);
      }
    },
    Qk = (e, t) => {
      const n = e.childNodes;
        ...
        i = Y(
          ...
          (t) =>
            ...
            t.matches.getOrThunk(() =>
              ((e) => (t) => {
                const n = Qk(t.startContainer, t.startOffset);
                return !((e, t) => {
                  var n;
                  const o =
  ...
  const tN = (e, t, n) => (e.stype === eN.Error ? t(e.serror) : n(e.svalue)),
    nN = (e) => ({ stype: eN.Value, svalue: e }),
    oN = (e) => ({ stype: eN.Error, serror: e }),
    rN = tN,
    sN = (e) =>
      f(e) && fe(e).length > 100
        ? " removed due to size"
        : JSON.stringify(e, null, 2),
    aN = (e, t) => oN([{ path: e, getErrorInfo: t }]),
    iN = (e) => ({
      extract: (t, n) => {
        return (
          (o = e(n)),
          (r = (e) => ((e, t) => aN(e, N(t)))(t, e)),
          o.stype === eN.Error ? r(o.serror) : o
        );
        var o, r;
      },
      toString: N("val"),
    ...
    cN = (e, t) =>
      iN((n) => {
        const o = typeof n;
        return e(n) ? nN(n) : oN(`Expected type: ${t} but got: ${o}`);
      }),
    uN = cN(E, "number"),
    mN = cN(m, "string"),
    fN = cN(b, "boolean"),
    ...
    pN = (e) => {
      ...
      switch ({}.toString.call(e).slice(8, -1)) {
        ...
        case "Array":
        case "Object":
          return Object.keys(e).every((t) => pN(e[t]));
        default:
          return !1;
      }
    };
  iN((e) =>
    pN(e)
      ? nN(e)
      : oN("Expected value to be acceptable for sending via postMessage"),
  );
  const hN = (e) => ({ tag: "defaultedThunk", process: N(e) }),
    bN = (e, t, n) => {
      switch (e.tag) {
        case "field":
    ...
    vN = (e) => {
      ...
      return t.errors.length > 0
        ? ((n = t.errors), S(oN, ee)(n))
        : nN(t.values);
      var n;
    },
    yN = (e, t, n, o) => o(_e(e, t).getOrThunk(() => n(e))),
    CN = (e, t, n, o, r) => {
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                ...
                (a = I.some),
                s.stype === eN.Value
                  ? { stype: eN.Value, svalue: a(s.svalue) }
                  : s
              );
              var s, a;
            },
      ...
      switch (e.tag) {
        ...
        case "defaultedThunk":
          return yN(n, o, e.process, s);
        case "option":
          return ((e, t, n) => n(_e(e, t)))(n, o, a);
        case "defaultedOptionThunk":
          return ((e, t, n, o) =>
            o(_e(e, t).map((t) => (!0 === t ? n(e) : t))))(n, o, e.process, a);
        case "mergeWithThunk":
          return yN(n, o, N({}), (t) => {
    ...
    EN = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) =>
            e.stype === eN.Error
              ? { stype: eN.Error, serror: t(e.serror) }
              : e)(t.extract([e], n), (e) => ({ input: n, errors: e })))(
          e,
          t,
          n,
        )),
        tN(o, Te.error, Te.value)
      );
      var o;
    },
    _N = (e, t, n, o) => ({
    ...
    xN = (e, t) => _N(e, e, { tag: "required", process: {} }, t),
    SN = (e) => xN(e, mN),
    kN = (e) => xN(e, gN),
    NN = (e, t) => _N(e, e, { tag: "option", process: {} }, t),
    RN = (e) => NN(e, mN),
    AN = (e) => NN(e, gN),
    TN = (e, t) => _N(e, e, hN(t), dN()),
    ON = (e, t, n) => _N(e, e, hN(t), n),
    BN = (e, t) => ON(e, t, uN),
    PN = (e, t) => ON(e, t, fN),
    DN = (e, t) => ON(e, t, gN),
    LN = SN("type");
  (SN("name"), SN("label"), SN("text"), SN("title"), SN("icon"), SN("url"));
  const MN = SN("value"),
    IN = kN("fetch");
  kN("getSubmenuItems");
  const FN = kN("onAction");
  (kN("onItemAction"), DN("onSetup", () => x), RN("name"));
  const UN = RN("text");
  RN("role");
  const zN = RN("icon");
  (RN("url"), RN("tooltip"), RN("label"), RN("shortcut"), AN("select"));
  const jN = PN("active", !1);
  PN("borderless", !1);
  const HN = PN("enabled", !0);
  PN("primary", !1);
  const $N = TN("meta", {});
  (DN("onAction", x),
    wN([
      (() => ON("type", "autocompleteitem", mN))(0, "autocompleteitem"),
      jN,
      HN,
      $N,
      MN,
  ...
  const VN = wN([
    ...
    ON(
      ...
      {
        extract: (e, t) => {
          const n = V(t, (t, n) => WN.extract(e.concat(["[" + n + "]"]), t));
          return vN(n);
        },
        toString: () => "array(" + WN.toString() + ")",
      }),
    )),
  ]);
  var qN, WN;
  const KN = (e) => {
      const t = e.ui.registry.getAll().popups,
        n = he(t, (e) => {
          return ((t = e), EN("Autocompleter", VN, t)).fold((e) => {
            throw new Error(
              "Errors: \n" +
                ((e) => {
                  const t =
    ...
    QN = (e, t) => I.from(e.getParent(t.container(), "details")),
    JN = (e, t) => QN(e, t).isSome(),
    eR = (e, t) => {
      const n = t.getNode();
      ...
      if ("character" === n) {
        ...
        return (
          !!(
            l &&
            (t ? c : d) &&
            wm(!t, s, n).exists((e) => JN(o, e) && !Ue(i, QN(o, e)))
          ) ||
          wm(t, s, n).fold(L, (n) => {
            const r = QN(o, n);
            if (JN(o, n) && !Ue(i, r)) {
          ...
          ? ((e, t) =>
            ...
            ((e, t, n) =>
              n.startDetails.exists((n) =>
                xm(e, t).forall((e) => !n.contains(e.container())),
              ))(a, s, t)
          : ((e, t) =>
              t.startSummary.exists((t) =>
    ...
    lR = Kt(),
    dR = lR.os,
    cR = dR.isMacOS() || dR.isiOS(),
    uR = lR.browser.isFirefox(),
    mR = (e, t) => {
      const n = e.dom,
    ...
    bR = (e, t, n, o, r = !0, s, a) => {
      ...
      return (hR(e, f), pR(g), f);
    },
    vR = (e, t) => {
      const n = null == e ? void 0 : e.parentNode;
      return C(n) && n.nodeName === t;
    },
    yR = (e) => C(e) && /^(OL|UL|LI)$/.test(e.nodeName),
    CR = (e) => C(e) && /^(LI|DT|DD)$/.test(e.nodeName),
    wR = (e) => {
      const t = e.parentNode;
      return CR(t) ? t : e;
    },
      ...
      insert: (e, t) => {
        ...
        E ||
          (n = ((e, t, n, o, r) => {
            var s, a;
            const i = e.dom,
              l = null !== (s = fR(i, o)) && void 0 !== s ? s : i.getRoot();
        ...
        if (/^(LI|DT|DD)$/.test(r) && qr(s) && i.isEmpty(S))
          return void ((e, t, n, o, r) => {
            ...
            var l;
            yR((l = n)) && yR(l.parentNode) && (r = "LI");
            const d = CR(o) ? _R(o) : void 0;
            let c = CR(o) && d ? t(r, { style: _R(o) }) : t(r);
            if (ER(n, o, !0) && ER(n, o, !1))
              if (vR(n, "LI")) {
                const e = wR(n);
                (s.insertAfter(c, e),
                  ((e) => {
              ...
              (vR(n, "LI")
                ? (s.insertAfter(c, wR(n)),
                  c.appendChild(s.doc.createTextNode(" ")),
                  c.appendChild(n))
                : i.insertBefore(c, n),
                s.remove(o));
            else if (ER(n, o, !1)) (s.insertAfter(c, wR(n)), s.remove(o));
            else {
              n = wR(n);
        ...
        if (!(p || (S !== e.getBody() && kR(i, S)))) return;
        ...
        if (p)
          ...
          ((R = Wi(S)), i.isEmpty(S) && pR(S), hR(e, R), mR(e, R));
        else if (v(!1)) R = w();
        else if (v(!0) && N) {
          ...
          const t = ((e) => {
            ...
            return (
              t.setStart(
                e.startContainer,
                NR(!0, e.startContainer, e.startOffset),
              ),
              t.setEnd(e.endContainer, NR(!1, e.endContainer, e.endOffset)),
              t
            );
          })(d).cloneRange();
          t.setEndAfter(S);
          ...
          (((e) => {
            ...
            i.isEmpty(S) && pR(S),
            R.normalize(),
            i.isEmpty(R) ? (i.remove(R), w()) : (hR(e, R), mR(e, R)));
        }
    ...
    OR = (e, t) => {
      BR(e.getBody(), t) || io(mn(t), cn("br"));
      const n = cn("br");
      (io(mn(t), n), AR(e, n.dom, !1), e.undoManager.add());
    },
    BR = (e, t) => {
      return (
        (n = Pl.after(t)),
    ...
    PR = (e) => e && "A" === e.nodeName && "href" in e,
    DR = (e) => e.fold(L, PR, PR, L),
    LR = (e, t) => {
      t.fold(x, T(TR, e), T(OR, e), x);
    },
    MR = {
      insert: (e, t) => {
        const n = ((e) => {
          ...
          return Q_(t, e.getBody(), n).filter(DR);
        })(e);
        n.isSome()
          ? n.each(T(LR, e))
          : ((e, t) => {
    ...
    jR = (e, t) => (n, o) => {
      const r =
        ((e) => gR(e).fold(N(""), (e) => e.nodeName.toUpperCase()))(n) ===
        e.toUpperCase();
      return r === t;
    },
    HR = (e) => {
      const t = fR(e.dom, e.selection.getStart());
      return y(t);
    },
    $R = (e) => jR("pre", e),
    VR = (e) => (t, n) => Rd(t) === e,
    qR = (e, t) => ((e) => IR(e, Bd(e)))(e),
    WR = (e, t) => t,
    KR = (e) => {
      const t = Ad(e),
        n = fR(e.dom, e.selection.getStart());
    ...
    XR = (e, t, n) => {
      if (!t.mode.isReadOnly()) {
        if (
          ...
          C(n) && iR(t, e.fakeEventName).isDefaultPrevented())
        )
          return;
        (e.insert(t, n), C(n) && aR(t, e.fakeEventName));
      }
    },
    ZR = (e, t) => {
      if (e.mode.isReadOnly()) return;
        ...
        r = ((e, t) =>
          H_(
            [
              GR([UR], FR.none()),
              GR([$R(!0), HR], FR.none()),
              GR([jR("summary", !0)], FR.br()),
              GR([$R(!0), VR(!1), WR], FR.br()),
              GR([$R(!0), VR(!1)], FR.block()),
              GR([$R(!0), VR(!0), WR], FR.block()),
              GR([$R(!0), VR(!0)], FR.br()),
              GR([zR(!0), WR], FR.br()),
              GR([zR(!0)], FR.block()),
              GR([qR], FR.br()),
    ...
    QR = Kt(),
    JR = QR.os.isiOS() && QR.browser.isSafari(),
    eA = (e, t) => {
      var n;
    ...
    tA = Kt(),
    nA = (e) => e.stopImmediatePropagation(),
    oA = (e) => e.keyCode === wg.PAGE_UP || e.keyCode === wg.PAGE_DOWN,
    rA = (e, t, n) => {
      (n && !e.get()
        ? t.on("NodeChange", nA, !0)
        : !n && e.get() && t.off("NodeChange", nA),
        e.set(n));
    },
    sA = (e, t) => e === t || e.contains(t),
    aA = (e, t) => {
      const n = t.container(),
        o = t.offset();
      return es(n)
            ...
            (
              (e) => (t) =>
                t.fold(
                  ...
                  (e) => km(e),
                  (e) => Nm(e),
                  (t) => xm(e.dom, Pl.after(t)),
                )
            )(n),
          )
          .map(
            (o) => () =>
              ((e, t, n) => (o) => (yh(e, o, n) ? iA(t) : lA(t)))(
                n,
                t,
                e.schema,
              )(o).each(dA(e)),
    ...
    mA = (e) =>
      lu(e)
        ? [
            { keyCode: wg.TAB, action: VS(zk, e, !0) },
            { keyCode: wg.TAB, shiftKey: !0, action: VS(zk, e, !1) },
          ]
        : [],
    fA = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), YN(e), Nw(e)))
        return Ne(null);
      {
        const t = Yx(e);
        return (
            ...
            e.on("beforeinput", (t) => {
              (e.selection.isEditable() &&
                !$(
                  ...
                  (t) =>
                    !((e, t) =>
                      !sA(e.getBody(), t.startContainer) ||
                      !sA(e.getBody(), t.endContainer) ||
                      tp(e.dom, t))(e, t),
                )) ||
                t.preventDefault();
            });
          ...
          ((e) => {
            e.on("keyup compositionstart", T(BS, e));
          })(e),
          ((e, t) => {
            e.on("keydown", (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  qS(
                    [
                      { keyCode: wg.RIGHT, action: VS(LS, e, !0) },
                      { keyCode: wg.LEFT, action: VS(LS, e, !1) },
                      { keyCode: wg.UP, action: VS(MS, e, !1) },
                      { keyCode: wg.DOWN, action: VS(MS, e, !0) },
                      ...(o
                        ? [
                            {
                              keyCode: wg.UP,
                        ...
                        : []),
                      { keyCode: wg.RIGHT, action: VS(Bk, e, !0) },
                      { keyCode: wg.LEFT, action: VS(Bk, e, !1) },
                      { keyCode: wg.UP, action: VS(Pk, e, !1) },
                      { keyCode: wg.DOWN, action: VS(Pk, e, !0) },
                      { keyCode: wg.UP, action: VS(Pk, e, !1) },
                      { keyCode: wg.UP, action: VS(jS, e, !1) },
                      { keyCode: wg.DOWN, action: VS(jS, e, !0) },
                      { keyCode: wg.RIGHT, action: VS(KS, e, !0) },
                      { keyCode: wg.LEFT, action: VS(KS, e, !1) },
                      { keyCode: wg.UP, action: VS(YS, e, !1) },
                      { keyCode: wg.DOWN, action: VS(YS, e, !0) },
                      { keyCode: wg.RIGHT, action: VS(Wx, e, t, !0) },
                      { keyCode: wg.LEFT, action: VS(Wx, e, t, !1) },
                      {
                        keyCode: wg.RIGHT,
                        ctrlKey: !o,
                        altKey: o,
                      ...
                      { keyCode: wg.UP, action: VS(zS, e, !1) },
                      { keyCode: wg.DOWN, action: VS(zS, e, !0) },
                    ],
                    n,
                  ).each((e) => {
                    n.preventDefault();
              ...
              ((n = o.keyCode === wg.BACKSPACE),
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    WS(
                      [
                        { keyCode: wg.BACKSPACE, action: VS(CS, e) },
                        { keyCode: wg.BACKSPACE, action: VS(S_, e, !1) },
                        { keyCode: wg.DELETE, action: VS(S_, e, !0) },
                        { keyCode: wg.BACKSPACE, action: VS(b_, e, !1) },
                        { keyCode: wg.DELETE, action: VS(b_, e, !0) },
                        { keyCode: wg.BACKSPACE, action: VS(eS, e, t, !1) },
                        { keyCode: wg.DELETE, action: VS(eS, e, t, !0) },
                        { keyCode: wg.BACKSPACE, action: VS(kb, e, !1) },
                        { keyCode: wg.DELETE, action: VS(kb, e, !0) },
                        { keyCode: wg.BACKSPACE, action: VS(rR, e, !1, s) },
                        { keyCode: wg.DELETE, action: VS(rR, e, !0, s) },
                        ...(cR
                          ? [
                              {
                                keyCode: wg.BACKSPACE,
                                altKey: !0,
                                action: VS(rR, e, !1, a(!0)),
                              },
                              {
                                keyCode: wg.DELETE,
                                altKey: !0,
                                action: VS(rR, e, !0, a(!0)),
                              },
                              {
                                keyCode: wg.BACKSPACE,
                                metaKey: !0,
                                action: VS(rR, e, !1, a(!1)),
                              },
                            ]
                          : [
                              {
                        ...
                        { keyCode: wg.BACKSPACE, action: VS(O_, e, !1) },
                        { keyCode: wg.DELETE, action: VS(O_, e, !0) },
                        { keyCode: wg.BACKSPACE, action: VS(mS, e, !1) },
                        { keyCode: wg.DELETE, action: VS(mS, e, !0) },
                        { keyCode: wg.BACKSPACE, action: VS(c_, e, !1) },
                        { keyCode: wg.DELETE, action: VS(c_, e, !0) },
                        { keyCode: wg.BACKSPACE, action: VS(i_, e, !1) },
                        { keyCode: wg.DELETE, action: VS(i_, e, !0) },
                        { keyCode: wg.BACKSPACE, action: VS(dS, e, !1) },
                        { keyCode: wg.DELETE, action: VS(dS, e, !0) },
                        { keyCode: wg.BACKSPACE, action: VS(T_, e, !1) },
                        { keyCode: wg.DELETE, action: VS(T_, e, !0) },
                      ],
                      n,
                    )
                      .filter((t) => e.selection.isEditable())
                      .each((t) => {
                        (n.preventDefault(),
                          iR(e, o).isDefaultPrevented() || (t(), aR(e, o)));
                      });
                  })(e, t, o));
            }),
              e.on("keyup", (t) => {
                (t.isDefaultPrevented() ||
                  ((e, t, n) => {
                    qS(
                      [
                        { keyCode: wg.BACKSPACE, action: VS(x_, e) },
                        { keyCode: wg.DELETE, action: VS(x_, e) },
                        ...(cR
                          ? [
                              {
                                keyCode: wg.BACKSPACE,
              ...
              e.on("keyup", (n) => {
                n.keyCode === wg.ENTER &&
                  t.each(() =>
                    ((e, n) => {
                      (e.undoManager.undo(),
                        t.fold(x, (t) => e.selection.moveToBookmark(t)),
                        eA(e, n),
                        (t = I.none()));
                    })(e, n),
                  );
            ...
            e.on("keydown", (t) => {
              t.isDefaultPrevented() ||
                ((e, t) => {
                  WS(
                    [
                      { keyCode: wg.SPACEBAR, action: VS(cA, e) },
                      { keyCode: wg.SPACEBAR, action: VS(uA, e) },
                    ],
                    t,
                  ).each((n) => {
                    (t.preventDefault(),
                      iR(e, "insertText", { data: " " }).isDefaultPrevented() ||
                        (n(), aR(e, "insertText", { data: " " })));
                  });
                })(e, t);
            });
          })(e),
            ...
            e.on("keydown", (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  qS(
                    [
                      { keyCode: wg.END, action: VS(IS, e, !0) },
                      { keyCode: wg.HOME, action: VS(IS, e, !1) },
                      ...(o
                        ? []
                        : [
                            {
                      ...
                      { keyCode: wg.END, action: VS(GS, e, !0) },
                      { keyCode: wg.HOME, action: VS(GS, e, !1) },
                      { keyCode: wg.END, action: VS(Zx, e, !0, t) },
                      { keyCode: wg.HOME, action: VS(Zx, e, !1, t) },
                    ],
                    n,
                  ).each((e) => {
                    n.preventDefault();
              ...
              e.on("keyup", (o) => {
                (o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    qS(
                      [
                        { keyCode: wg.PAGE_UP, action: VS(Zx, e, !1, t) },
                        { keyCode: wg.PAGE_DOWN, action: VS(Zx, e, !0, t) },
                      ],
                      n,
                    );
                  })(e, t, o),
                  oA(o) && n.get() && (rA(n, e, !1), e.nodeChanged()));
              }));
          })(e, t),
          t
        );
  ...
  const pA = "x-tinymce/html",
    hA = N(pA),
    bA = "\x3c!-- " + pA + " --\x3e",
    vA = (e) => bA + e,
    yA = (e) => -1 !== e.indexOf(bA),
    CA = "%MCEPASTEBIN%",
    wA = (e) => e.dom.get("mcepastebin"),
    EA = (e) => C(e) && "mcepastebin" === e.id,
    _A = (e) => e === CA,
    xA = (e, t) => (
      an.each(t, (t) => {
    ...
    kA = (e, t) => ({ content: e, cancelled: t }),
    NA = (e, t) => (e.insertContent(t, { merge: Kc(e), paste: !0 }), !0),
    ...
    TA = (e, t, n) =>
      !!((e, t) =>
        RA(t) && $(iu(e), (e) => Ge(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t,
      ) &&
      ((e, t, n) => (
        ...
        ((e, t, n) => {
          ...
          return e.hasEventListeners("PastePostProcess") &&
            ...
            ? ((e, t, n) => {
                ...
                return kA(r.node.innerHTML, r.isDefaultPrevented());
              })(e, r, n)
            : kA(r, o.isDefaultPrevented());
        })(e, t, n))(e, t, n);
      if (!s.cancelled) {
        const t = s.content,
          n = () =>
            ((e, t, n) => {
              n || !Yc(e)
                ? NA(e, t)
                : ((e, t) => {
                    an.each([AA, TA, NA], (n) => !n(e, t, NA));
                  })(e, t);
            })(e, t, o);
        r
          ? iR(e, "insertFromPaste", {
              dataTransfer: BA(t),
            }).isDefaultPrevented() || (n(), aR(e, "insertFromPaste"))
          : n();
      }
    },
    DA = (e, t, n, o) => {
      const r = n || yA(t);
      PA(e, ((e) => e.replace(bA, ""))(t), r, !1, o);
    },
    LA = (e, t, n) => {
    ...
    IA = (e, t) => t in e && e[t].length > 0,
    FA = (e) => IA(e, "text/html") || IA(e, "text/plain"),
    UA = (e, t, n) => {
      ...
      if (jc(e) && o) {
        ...
        if (s.length > 0)
          return (
            ...
            ((r = s),
            Promise.all(
              V(r, (e) => by(e).then((t) => ({ file: e, uri: t }))),
            )).then((t) => {
              (n && e.selection.setRng(n),
                q(t, (t) => {
                  ((e, t) => {
                    py(t.uri).each(({ data: n, type: o, base64Encoded: r }) => {
                      const s = r ? n : btoa(n),
                        a = t.file,
      ...
      (((e, t, n) => {
        ...
        (e.on("keydown", (e) => {
          ...
          e.on("paste", (r) => {
            ...
            (!FA(a) && UA(e, r, t.getLastRng() || e.selection.getRng())) ||
              (IA(a, "text/html")
                ? (r.preventDefault(), zA(e, a, a["text/html"], s, !0))
                : IA(a, "text/plain") && IA(a, "text/uri-list")
                  ? (r.preventDefault(), zA(e, a, a["text/plain"], s, !0))
                  : (t.create(),
                    sg.setEditorTimeout(
                      e,
                      () => {
                        const n = t.getHtml();
                        (t.remove(), zA(e, a, n, s, !1));
                      },
                      0,
                    )));
          }));
    ...
    VA = (e) => ({
      html: vA(e.selection.getContent({ contextual: !0 })),
    ...
    YA = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi,
    GA = (e) => an.trim(e).replace(YA, Ma).toLowerCase(),
    XA = (e, t, n) => {
      const o = qc(e);
            ...
            remove: () =>
              ((e, t) => {
                ...
                if (wA(e)) {
                  let o;
                  const r = t.get();
                  for (; (o = wA(e)); ) (n.remove(o), n.unbind(o));
          ...
          (((e) => {
            (e.on(
              ...
              e.on(
                "copy",
                ((e) => (t) => {
                  !t.isDefaultPrevented() && qA(e) && HA(t, VA(e), $A(e), x);
                })(e),
              ));
          })(e),
            ((e, t) => {
              (zc(e) &&
                      ...
                      sg.setEditorTimeout(e, () => {
                        e.undoManager.transact(() => {
                          ((a || (d && l)) && e.execCommand("Delete"),
                            KA(e, o));
                          const t = SA(i);
                          r["text/html"] ? DA(e, t, s, !0) : LA(e, t, !0);
                        });
                      })));
                }),
                e.on("dragstart", (e) => {
                ...
                e.on("dragover dragend", (n) => {
                  (jc(e) && !t.get() && (n.preventDefault(), KA(e, WA(e, n))),
    ...
    eT = (e) => cs(e.dom),
    tT = (e) => (t) => Cn(mn(e), t),
    nT = (e, t) => tr(mn(e), eT, tT(t)),
    oT = (e, t, n) => {
      const o = new Fr(e, t),
        r = n ? o.next.bind(o) : o.prev.bind(o);
      let s = e;
      for (let t = n ? e : r(); t && !QA(t); t = r()) fl(t) && (s = t);
      return s;
    },
    rT = (e) => {
      const t = ((e, t, n) => {
  ...
  const aT = (e, t) => Math.abs(e.left - t),
    iT = (e, t) => Math.abs(e.right - t),
    lT = (e, t) =>
      ((e) =>
        X(
          e,
    ...
    uT = (e, t, n) =>
      ((e, t, n) => {
        ...
        .map((e) =>
          ((e, t) => ({
            node: e.node,
            position: aT(e, t) < iT(e, t) ? sT.Before : sT.After,
          }))(e, t),
        ),
    mT = (e) => {
      var t, n;
    ...
    gT = (e, t, n, o) => {
      ...
      return v(o)
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...fT(n) }))(
            e,
            o,
            t,
            r,
    ...
    xT = (e, t, n, o, r) => {
      "dragstart" === t && wk(o, e.dom.getOuterHTML(n));
      const s = gT(t, n, o, r);
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? mT(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
                    ...
                    (r = ((e, t) => {
                      if (t.target.ownerDocument !== e.getDoc()) {
                        const n = mT(e.getContentAreaContainer()),
                          o = ((e) => {
                            const t = e.getBody(),
    ...
    RT = (e) => {
      const t = Ve(),
        ...
        r = ((e, t) => (n) => {
          if (((e) => 0 === e.button)(n)) {
            const o = Q(t.dom.getParents(n.target), hT).getOr(null);
            if (
              C(o) &&
              ((e, t, n) => pT(n) && n !== t && e.isEditable(n.parentElement))(
                t.dom,
                t.getBody(),
                o,
              )
              ...
              e.set({
                ...
                ghost: bT(t, o, o.offsetWidth, o.offsetHeight),
                intervalId: $e(100),
              });
            }
          }
      ...
      (e.on("mousedown", r),
        ...
        e.on("keydown", (n) => {
          n.keyCode === wg.ESC && kT(t, e, I.none());
        }));
    },
    AT = cs,
    TT = (e, t) => Nb(e.getBody(), t),
    OT = (e) => {
      const t = e.selection,
        n = e.dom,
        o = e.getBody(),
      ...
      return (
        Nw(e) ||
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = TT(e, n);
              AT(o)
                ? (t.preventDefault(), m_(e, o).each(f))
                : l(n) && m_(e, n).each(f);
            },
            !0,
          ),
          e.on("mousedown", (r) => {
                ...
                const o = mn(e.getBody()),
                  ...
                  s = ((e, t, n, o) => {
                    ...
                    return {
                      ...
                      y: o - (e ? r.top + t.dom.clientTop + sE(t) : 0),
                    };
                  })(e.inline, r, t, n);
                return ((e, t, n) => {
                  const o = oE(e),
            ...
            const a = TT(e, s);
            AT(a)
              ? (r.preventDefault(), m_(e, a).each(f))
              : uT(o, r.clientX, r.clientY).each((n) => {
                  var o;
                  (r.preventDefault(),
                    (o = d(1, n.node, n.position === sT.Before, !1)) &&
                      t.setRng(o),
                    Wr(a) ? a.focus() : e.getBody().focus());
                });
          }),
          e.on("keypress", (e) => {
            wg.modifierPressed(e) || (AT(t.getNode()) && e.preventDefault());
          }),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          "drop" === t.type &&
                            mE(e, "Dropped file type is not supported"));
                      }
                    },
                    n = (n) => {
                      mg(e, n.target) && t(n);
              ...
              e.on("focusin", (t) => {
                ...
                if (gs(n)) {
                  ...
                  e.selection.getNode() !== o &&
                    m_(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    MT = (e, t) =>
      LT(e, t.start).bind(({ node: n, offset: o }) =>
        LT(e, t.end).map(({ node: e, offset: t }) => {
          const r = document.createRange();
    ...
    IT = (e, t, n) => {
      if (t && e.isEmpty(t) && !n(t)) {
        const o = t.parentNode;
        (e.remove(t, es(t.firstChild) && zr(t.firstChild.data)), IT(e, o, n));
      }
    },
    FT = (e, t, n, o = !0) => {
    ...
    UT = (e, t) => I.from(e.dom.getParent(t.startContainer, e.dom.isBlock)),
    zT = (e, t, n) => {
    ...
    HT = (e, t) => e.create("span", { "data-mce-type": "bookmark", id: t }),
    $T = (e, t) => {
      const n = e.createRng();
    ...
    VT = (e, t, n) => {
      ...
      return {
        prefix: t,
        end: a.parentNode.insertBefore(HT(e, t + "-end"), a),
        start: l.insertBefore(HT(e, t + "-start"), i),
      };
    },
    qT = (e, t, n) => {
      (IT(e, e.get(t.prefix + "-end"), n),
        IT(e, e.get(t.prefix + "-start"), n));
    },
      ...
      return Kk(
        ...
        }
        {
          ...
          return qk(o.container, s, n)
            ...
            .orThunk(() => KT(e, t, n, jk(o.container, 0)));
        }
      });
    },
    YT = (e, t, n, o) => {
      ...
      return qk(i, l - n.pattern.end.length, t).bind((d) => {
        ...
        {
          const i = GT(e, n.remainingPatterns, d.container, d.offset, t, o),
          ...
          return m.map((e) => {
            ...
            return {
              ...
              position: jk(e.startContainer, e.startOffset),
            };
          });
        }
      });
    ...
    GT = (e, t, n, o, r, s) => {
      const a = e.dom;
      return Vk(n, o, a.getRoot()).bind((i) => {
        const l = jT(a, r, n, o);
        for (let a = 0; a < t.length; a++) {
          const d = t[a];
          if (!Ge(l, d.end)) continue;
          const c = t.slice();
          c.splice(a, 1);
          const u = YT(
            e,
          ...
          if (u.isNone() && o > 0) return GT(e, t, n, o - 1, r, s);
    ...
    ZT = (e, t, n, o, r, s) => {
      ...
      return ((e, t) => {
        ...
        GT(e, r.inlinePatterns, n, o, t, s).fold(
          () => [],
          (e) => e.matches,
        ),
        GT(
    ...
    QT = (e, t) => {
        ...
        r = ((e, t) => {
          const n = De("mce_textpattern"),
            o = G(
              t,
              (t, o) => {
                const r = VT(e, n + `_end${t.length}`, o.endRng);
      ...
      (q(r, (t) => {
        ...
        (WT(t.pattern)
          ...
          qT(n, t.endMarker, r),
          qT(n, t.startMarker, r));
      }),
        e.selection.moveToBookmark(o));
    },
    JT = (e, t, n) =>
      ((e, t, n) => {
        if (es(e) && 0 >= e.length) return I.some(jk(e, 0));
        {
          const t = Ei(Hk);
          return I.from(t.forwards(e, 0, $k(e), n)).map((e) =>
            jk(e.container, 0),
          );
        }
      })(t, 0, t).map((o) => {
      ...
      return (
        UT(t, s).each((n) => {
          "block-format" === r.type
            ? ((e, t) => {
                const n = t.get(e);
                return p(n) && le(n).exists((e) => xe(e, "block"));
    ...
    rO = tO((e, t, n) => 0 === t.indexOf(e.start) || 0 === n.indexOf(e.start)),
    sO = nO(rO, !0),
    aO = eO(JT),
    iO = tO((e, t, n) => t === e.start || n === e.start),
    lO = nO(iO, !1),
    dO = (e, t, n) => {
    ...
    cO = (e) => {
                ...
                ((e, t) => {
                  ...
                  return UT(e, n)
                    .map((o) => {
                      ...
                      return {
                        inlineMatches: ZT(e, o, n.startContainer, s, a, !0),
                        blockMatches: sO(e, o, a, !0),
                      };
                    })
                    .filter(
            ...
            ((e, t) => {
              ...
              UT(e, n).map((o) => {
                const r = Math.max(0, n.startOffset - 1),
                  s = jT(e.dom, o, n.startContainer, r),
                  a = zT(t, o, s),
                  i = ZT(e, o, n.startContainer, r, a, !1);
                i.length > 0 &&
                  e.undoManager.transact(() => {
                    QT(e, i);
                  });
      ...
      (e.on("keyup", (e) => {
        dO(n, e, (e, t) => e === t.keyCode && !wg.modifierPressed(t)) && s();
      }),
        e.on("keypress", (n) => {
          dO(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
    ...
    mO = ni.DOM,
    fO = (e) => (e.inline ? e.getElement().nodeName.toLowerCase() : void 0),
    gO = (e) => Ce(e, (e) => !1 === v(e)),
    pO = (e) => {
    ...
    bO = (e) => (e.inline ? e.ui.styleSheetLoader : e.dom.styleSheetLoader),
    vO = (e) => {
      const t = bO(e),
        n = Jd(e),
        o = e.contentCSS,
      ...
      const a = Promise.all(
          ((e, t, n) => {
            const { pass: o, fail: r } = K(t, (e) =>
                tinymce.Resource.has(SE(e)),
              ),
              s = o.map((t) => {
                const n = tinymce.Resource.get(SE(t));
                return m(n)
                  ? Promise.resolve(bO(e).loadRawCss(t, n))
                  : Promise.resolve();
              }),
              a = [...s, bO(e).loadAll(r)];
    ...
    yO = (e) => {
      !0 !== e.removed &&
        (((e) => {
          (Nw(e) || e.load({ initial: !0, format: "html" }),
    ...
    CO = (e) => {
      ...
      let n = e.getDoc();
      e.inline &&
        (mO.addClass(t, "mce-content-body"),
      ...
      ((o.disabled = !0),
        ...
        !hu(e) &&
          e.hasEditableRoot() &&
          (e.inline &&
            "static" === mO.getStyle(o, "position", !0) &&
        ...
        (e.parser = ((e) => {
          const t = KC(pO(e), e.schema);
          return (
            t.addAttributeFilter(
              "data-mce-src,data-mce-href,data-mce-style",
              (e, t) => {
                for (let n = 0; n < e.length; n++) e[n].attr(t, null);
              },
            ),
        ...
        (e.selection = Lw(e.dom, e.getWin(), e.serializer, e)),
        (e.annotator = Kf(e)),
        (e.formatter = VE(e)),
        (e.undoManager = WE(e)),
        (e._nodeChangeDispatcher = new gA(e)),
        (e._selectionOverrides = OT(e)),
        ((e) => {
          const t = Ve(),
            n = Ne(!1),
            o = rt((t) => {
            ...
            e.on("BeforeSetContent", (t) => {
              ((e, t, n) => {
                let o = t.length,
                  r = n.content;
                if ("raw" !== n.format) {
                  for (; o--; ) r = r.replace(t[o], AS(e, r, eu(e)));
                  n.content = r;
                }
              })(e, a, t);
            }),
        ...
        Nw(e) ||
          (((e) => {
            e.on("mousedown", (t) => {
              t.detail >= 3 && (t.preventDefault(), rT(e));
            });
          })(e),
          ((e) => {
            cO(e);
          ...
          e.on("NodeChange", () =>
            ((e) => {
              ...
              if (
                ...
                ((e, t, n) => $(Zp(mn(n), mn(t)), (t) => _S(e, t.dom)))(r, a, s)
              )
                return;
              ...
              for (; m; )
                if ((qr(m) && Is(o, m), xS(o, m))) {
                  ...
                  if (!i) {
                    ...
                    ((i = kS(e)), a.insertBefore(i, m));
                  }
                  ((l = m), (m = m.nextSibling), i.appendChild(l));
                } else ((i = null), (m = m.nextSibling));
              d && (e.selection.setRng(A_(d)), e.nodeChanged());
            })(e),
          );
        })(e),
        ((e) => {
      ...
      const s = ((e) => {
        const t = e;
        return ((e) => _e(e.plugins, "rtc").bind((e) => I.from(e.setup)))(
          e,
        ).fold(
          () => ((t.rtcInstance = kw(e)), I.none()),
          (e) => (
            (t.rtcInstance = (() => {
              const e = N(null),
                t = N("");
      ...
      (((e) => {
        ...
        (((e) => {
          ...
          Fc(e) ||
            ((t.body.spellcheck = !1), mO.setAttrib(n, "spellcheck", "false")),
          (e.quirks = uO(e)),
          ((e) => {
        ...
        (r &&
          ((e, t) => {
            (((e, t) => {
              ...
              ((e, t) => {
                e.serializer.addNodeFilter("#comment", (e) => {
                  let n = e.length;
                  for (; n--; ) {
                    const o = e[n],
                      r = o.value;
                    if (
                      0 === (null == r ? void 0 : r.indexOf("mce:protected "))
                    ) {
                      const e = unescape(r).substr(14);
                      $(t, (t) => {
                        const n = e.match(t);
                        return null !== n && n[0].length === e.length;
                      })
                        ? ((o.name = "#text"),
                          (o.type = 3),
                          (o.raw = !0),
          ...
          (t) => {
            (e.setProgressState(!0),
              vO(e).then(() => {
                t().then(
                  (t) => {
                    (e.setProgressState(!1), yO(e), Tw(e));
                  },
                  (t) => {
                    (e.notificationManager.open({
                      type: "error",
    ...
    wO = ni.DOM,
    EO = ni.DOM,
    _O = (e, t) => ({ editorContainer: e, iframeContainer: t, api: {} }),
    xO = (e) => {
      const t = e.getElement();
      return e.inline
        ? _O(null)
        : ((e) => {
            const t = EO.create("div");
            return (EO.insertAfter(t, e), _O(t, t));
          })(t);
    },
    SO = async (e) => {
      (e.dispatch("ScriptsLoaded"),
        ...
        ((e) => {
          ...
          if (m(t)) {
            const n = dE.get(t);
            ((e.theme = n(e, dE.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(
                  e,
                  dE.urls[t] || e.documentBaseUrl.replace(/\/$/, ""),
                ));
          } else e.theme = {};
        })(e),
        ((e) => {
        ...
        ((e) => {
          ...
          q(Nc(e), (n) => {
            ((e, t, n) => {
              const o = lE.get(n),
                r = lE.urls[n] || e.documentBaseUrl.replace(/\/$/, "");
      ...
      (((e, t) => {
        const n = {
          show: I.from(t.show).getOr(x),
          hide: I.from(t.hide).getOr(x),
          isEnabled: I.from(t.isEnabled).getOr(M),
          setEnabled: (n) => {
            (n && ("readonly" === e.mode.get() || CE(e))) ||
          ...
          : ((e, t) => {
              (((e, t) => {
                ...
                ((s.onload = () => {
                  ...
                  (e.iframeElement = s),
                  (e.iframeHTML = ((e) => {
                    let t = _d(e) + "<html><head>";
                    (xd(e) !== e.documentBaseUrl &&
                      (t +=
                  ...
                  wO.add(t.iframeContainer, s));
              })(e, t),
                t.editorContainer &&
                  ((t.editorContainer.style.display = e.orgDisplay),
                  (e.hidden = wO.isHidden(t.editorContainer))),
                (e.getElement().style.display = "none"),
                wO.setAttrib(e.id, "aria-hidden", "true"),
    ...
    AO = (e, t) => {
      ...
      (((e, t) => {
        ...
        if (m(n) && !NO(n) && !xe(dE.urls, n)) {
          ...
          dE.load(n, r).catch(() => {
            ((e, t, n) => {
              fE(e, "ThemeLoadError", gE("theme", t, n));
            })(e, r, n);
          });
        }
      })(e, t),
        ((e, t) => {
          ...
          if ("plugin" !== n && !xe(eE.urls, n)) {
            ...
            eE.load(n, r).catch(() => {
              ((e, t, n) => {
                fE(e, "ModelLoadError", gE("model", t, n));
              })(e, r, n);
            });
          }
        })(e, t),
        ((e, t) => {
          ...
          if (!li.hasCode(n) && "en" !== n) {
            ...
            e.add(r).catch(() => {
              ((e, t, n) => {
                fE(e, "LanguageLoadError", gE("language", t, n));
              })(t, r, n);
            });
          }
        })(n, e),
        ((e, t, n) => {
          ...
          q(
            ...
            (n) => {
              e.add(n.url).catch(() => {
                ((e, t, n) => {
                  fE(e, "IconsLoadError", gE("icons", t, n));
        ...
        ((e, t) => {
          const n = (t, n) => {
            lE.load(t, n).catch(() => {
              ((e, t, n) => {
                fE(e, "PluginLoadError", gE("plugin", t, n));
              })(e, n, t);
            });
          };
          (pe(Rc(e), (t, o) => {
    ...
    LO = (e, t) => xe(e.sections(), t),
    MO = (e, t) => ({
      table_grid: !1,
      object_resizing: !1,
      resize: !1,
      toolbar_mode: _e(e, "toolbar_mode").getOr("scrolling"),
      toolbar_sticky: !1,
      ...(t ? { menubar: !1 } : {}),
    }),
    IO = (e, t) => {
      ...
      const a = e
        ...
        l = an.extend(
          ...
          ((e, t) => e && LO(t, "mobile"))(e, i)
            ...
            : {},
          { external_plugins: IO(o, i.options()) },
        );
      return ((e, t, n, o) => {
        const r = PO(n.forced_plugins),
          s = PO(o.plugins),
          a = ((e, t) => (LO(e, t) ? e.sections()[t] : {}))(t, "mobile"),
          i = ((e, t, n, o) => (e && LO(t, "mobile") ? o : n))(
            e,
            t,
            s,
            a.plugins ? PO(a.plugins) : s,
          ),
          l = ((e, t) => [...PO(e), ...PO(t)])(r, i);
    ...
    HO = { "font-size": "size", "font-family": "face" },
    $O = On("font"),
    VO = (e) => (t, n) =>
      I.from(n)
        .map(mn)
          ...
          ((e, t, n) =>
            _r(
              ...
              (t) =>
                ((t) =>
                  Io(t, e).orThunk(() =>
                    $O(t) ? _e(HO, e).bind((e) => bo(t, e)) : I.none(),
                  ))(t),
              (e) => Cn(mn(t), e),
            ))(e, t, n.dom).or(
      ...
      (UO(e),
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            insertImage: (t, n, o) => {
              jO(e, e.dom.createHTML("img", { src: o }));
            },
        ...
        ((e) => {
          (e.editorCommands.addCommands({
            ...
            e.editorCommands.addCommands({ Outdent: () => pS(e) }, "state"));
        })(e),
        ((e) => {
          e.editorCommands.addCommands({
        ...
        ((e) => {
          (((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontSize: (t, n, o) => {
                ((e, t) => {
                  (e.formatter.toggle("fontsize", { value: GO(e, t) }),
                    e.nodeChanged());
                })(e, o);
              },
              LineHeight: (t, n, o) => {
            ...
            ((e) => {
              ...
              (e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler("FontName", () =>
                  ((e) => YO(e, (t) => WO(e.getBody(), t.dom)).getOr(""))(e),
                ),
                e.editorCommands.addQueryValueHandler("FontSize", () =>
                  ((e) => YO(e, (t) => qO(e.getBody(), t.dom)).getOr(""))(e),
                ),
                e.editorCommands.addQueryValueHandler("LineHeight", () =>
                  ((e) =>
                    YO(e, (t) => {
                      const n = mn(e.getBody()),
                        o = _r(t, (e) => Io(e, "line-height"), T(Cn, n));
                      return o.getOrThunk(() => {
  ...
  class tB {
    ...
    queryCommandState(e) {
      if ((!eB(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
  ...
  const rB = (e) => (
      e._eventDispatcher ||
        (e._eventDispatcher = new oB({
          scope: e,
          toggleEvent: (t, n) => {
            oB.isNative(t) && e.toggleNativeEvent && e.toggleNativeEvent(t, n);
          },
        })),
      e._eventDispatcher
    ),
    sB = {
      ...
      on(e, t, n) {
        return rB(this).on(e, t, n);
      },
      off(e, t) {
        return rB(this).off(e, t);
      },
      once(e, t) {
        return rB(this).once(e, t);
      },
      hasEventListeners(e) {
        return rB(this).has(e);
      },
    },
    aB = ni.DOM;
  let iB;
  const lB = (e, t) => {
      ...
      const n = sc(e);
      return n
        ? (e.eventRoot || (e.eventRoot = aB.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    dB = (e, t, n) => {
      ((e) => !e.hidden && !CE(e))(e)
    ...
    cB = (e, t) => {
      ...
      if (sc(e)) {
        ...
        const o = (n) => {
          ...
          for (; s--; ) {
            const e = r[s].getBody();
            (e === o || aB.isChildOf(o, e)) && dB(r[s], t, n);
          }
        };
        ((iB[t] = o), aB.bind(n, t, o));
      } else {
        const o = (n) => {
          dB(e, t, n);
        };
        (aB.bind(n, t, o), (e.delegates[t] = o));
      }
    },
    uB = {
      ...sB,
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(lB(n, e), e, n.delegates[e]),
    ...
    fB = (e, t) => e + (tt(t.message) ? "" : `. ${t.message}`),
    gB = (e) => e.valid,
    pB = (e, t, n = "") => {
      const o = t(e);
      return b(o)
            ...
            ((e) => {
              (e.on("ShowCaret ObjectSelected", (t) => {
                ...
                e.on("DisabledStateChange", (t) => {
                  t.isDefaultPrevented() || EE(e, t.state);
                }));
            })(e));
        })(e),
        {
    ...
    _B = an.makeMap("alt,ctrl,shift,meta,access"),
    xB = (e) => {
      const t = {},
        n = nn.os.isMacOS() || nn.os.isiOS();
      CB(wB(e.toLowerCase(), "+"), (e) => {
        ((e) => e in _B)(e)
          ? (t[e] = !0)
          : /^[0-9]{2,}$/.test(e)
            ? (t.keyCode = parseInt(e, 10))
            : ((t.charCode = e.charCodeAt(0)),
              (t.keyCode = EB[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
      for (r in _B) t[r] ? o.push(r) : (t[r] = !1);
      return (
        (t.id = o.join(",")),
  ...
  class TB {
    constructor(e, t, n) {
      ...
      ((this.options = ((e, t, n = t) => {
        const o = {},
          ...
          s = (e, t, n) => {
            ...
            return gB(o)
              ? ((r[e] = o.value), !0)
              : (console.warn(
                  fB(`Invalid value passed for the ${e} option`, o),
                ),
                !1);
          },
          a = (e) => xe(o, e);
        return {
          register: (e, n) => {
            const a = ((e) => m(e.processor))(n)
                ? ((e) => {
                    ...
                    return (n) => pB(n, t, `The value must be a ${e}.`);
                  })(n.processor)
                : n.processor,
              i = ((e, t, n) => {
                if (!v(t)) {
                  const o = pB(t, n);
                  if (gB(o)) return o.value;
                  console.error(
                    fB(`Invalid default value passed for the "${e}" option`, o),
                  );
                }
              })(e, n.default, a);
          ...
          get: (e) =>
            _e(r, e)
              .orThunk(() => _e(o, e).map((e) => e.default))
              .getOrUndefined(),
          set: (e, t) => {
            if (a(e)) {
              const n = o[e];
        ...
        ((e) => {
          ...
          (t("id", { processor: "string", default: e.id }),
            ...
            t("allow_html_in_comments", { processor: "boolean", default: !0 }),
      ...
      (C(d) && ni.DOM.styleSheetLoader._setContentCssCors(d),
        ...
        this.setDirty(!1),
        (this.documentBaseURI = new BC(xd(o), { base_uri: this.baseUri })),
        (this.baseURI = this.baseUri),
        (this.inline = bc(o)),
        (this.hasVisual = Tc(o)),
        (this.shortcuts = new SB(this)),
        (this.editorCommands = new tB(this)),
        QO(this));
    ...
    render() {
      ((e) => {
        ...
        if (!Wa.Event.domLoaded) return void kO.bind(window, "ready", n);
        ...
        (s &&
          ...
          (e.windowManager = cE(e)),
          (e.notificationManager = iE(e)),
    ...
    hasPlugin(e, t) {
      return !(!H(Nc(this), e) || (t && void 0 === lE.get(e)));
    }
    nodeChanged(e) {
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (NB.show(e.getContainer()), NB.hide(e.id)),
        e.load(),
        e.dispatch("show"));
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (NB.hide(e.getContainer()),
            NB.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    save(e = {}) {
      ...
      if (
        ...
        const o = NB.getParent(t.id, "form");
        o && AB(o.elements, (e) => e.name !== t.id || ((e.value = r), !1));
      }
      return (
    ...
    resetContent(e) {
      (void 0 === e
        ? Uw(this, this.startContent, { format: "raw" })
        : Uw(this, e),
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || NB.get(e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = NB.get(this.id)),
        this.targetElm
      );
    }
    getWin() {
        ...
        if (!e.removed) {
          ...
          (o && e.save({ is_removing: !0 }),
            ...
            !e.inline &&
              o &&
              ((e) => {
                Zw.setStyle(e.id, "display", e.orgDisplay);
              })(e),
            ((e) => {
              e.dispatch("detach");
            })(e),
            Zw.remove(e.getContainer()),
            Qw(t),
            Qw(n),
            e.destroy());
        }
            ...
            ? (t ||
              ...
              ((e) => {
                ...
                t &&
                  ...
                  Zw.unbind(t, "submit reset", e.formEventDelegate));
              })(e),
              ((e) => {
                const t = e;
  ...
  const MB = (e) => {
    ...
    IB = (e) => {
      if (e !== DB) {
        const t = ni.DOM;
        (e
          ? (t.bind(window, "resize", MB), t.bind(window, "scroll", MB))
          : (t.unbind(window, "resize", MB), t.unbind(window, "scroll", MB)),
          (DB = e));
      }
    },
    FB = (e) => {
      ...
      return (
        (LB = Y(LB, (t) => e !== t)),
        zB.activeEditor === e &&
          (zB.activeEditor = LB.length > 0 ? LB[0] : null),
        zB.focusedEditor === e && (zB.focusedEditor = null),
        t.length !== LB.length
      );
    },
    UB = "CSS1Compat" !== document.compatMode,
    zB = {
      ...sB,
      baseURI: null,
      baseURL: null,
      ...
      setup() {
        ...
        let t = "",
          n = "",
          o = BC.getDocumentBaseUrl(document.location);
        /^[^:]+:\/\/\/?[^\/]+\//.test(o) &&
          ((o = o.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
          /[\/\\]$/.test(o) || (o += "/"));
        ...
        var s;
        ((e.baseURL = new BC(o).toAbsolute(t)),
          (e.documentBaseURL = o),
          (e.baseURI = new BC(e.baseURL)),
          (e.suffix = n),
      ...
      createEditor(e, t) {
        return this.add(new TB(e, t, this));
      },
      remove(e) {
        const t = this;
        let n;
        if (e) {
          if (!m(e))
            return (
              ...
              h(t.get(n.id))
                ? null
                : (FB(n) && t.dispatch("RemoveEditor", { editor: n }),
                  0 === LB.length &&
        ...
        } else for (let e = LB.length - 1; e >= 0; e--) t.remove(LB[e]);
      },
      execCommand(e, t, n) {
        var o;
        const r = this,
      ...
      _setBaseUrl(e) {
        ((this.baseURL = new BC(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, ""),
        )),
          (this.baseURI = new BC(this.baseURL)));
      },
    };
  zB.setup();
  const jB = (() => {
      ...
      return {
        FakeClipboardItem: (e) => ({
          items: e,
          types: fe(e),
          getType: (t) => _e(e, t).getOrUndefined(),
        }),
        write: (t) => {
          e.set(t);
        },
    ...
    WB = (e, t, n, o) => ({ x: e, y: t, w: n, h: o }),
    KB = {
      inflate: (e, t, n) => WB(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n),
      relativePosition: qB,
      ...
      intersect: (e, t) => {
        const n = $B(e.x, t.x),
          o = $B(e.y, t.y),
          r = HB(e.x + e.w, t.x + t.w),
          s = HB(e.y + e.h, t.y + t.h);
        return r - n < 0 || s - o < 0 ? null : WB(n, o, r - n, s - o);
      },
      clamp: (e, t, n) => {
        let o = e.x,
          r = e.y,
  ...
  const XB = {
      ...
      util: {
        ...
        ImageUploader: (e) => {
          const t = RE(),
            n = BE(e, t);
          return { upload: (t, o = !0) => n.upload(t, o ? OE(e) : void 0) };
        },
      },
      dom: {
        EventUtils: Wa,
