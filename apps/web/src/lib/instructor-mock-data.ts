...
export const MOCK_INSTRUCTOR_BATCHES: Batch[] = [
  {
    ...
    maxStudents: 30,
    description:
      "Python for Data Science — covers Python basics through machine learning.",
  ...
  },
  {
    ...
    maxStudents: 25,
    description:
      "React Full Stack — from React fundamentals to advanced server components.",
  ...
  },
  {
    ...
    maxStudents: 30,
    description:
      "AWS Cloud Architecture — compute, storage, networking, security, and beyond.",
...
export const MOCK_INSTRUCTOR_TICKETS: MentorshipTicket[] = [
  ...
  },
  {
    ...
    description:
      "Need help understanding the difference between VPC peering and Transit Gateway in AWS.",
    status: "ASSIGNED",
