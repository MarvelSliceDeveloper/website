          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Percentage of students completing all module materials
              </p>
            </div>
          </div>
          {loading ? (
        ...
        <div className="border border-border bg-card p-5 rounded-2xl shadow-xs">
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Student engagement trend over past months
              </p>
            </div>
          </div>
          {loading ? (
        ...
        <div className="border border-border bg-card p-5 rounded-2xl shadow-xs">
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Retention breakdown across video lesson duration
              </p>
            </div>
          </div>
          {loading ? (
        ...
        <div className="border border-border bg-card p-5 rounded-2xl shadow-xs">
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Average percentage score per quiz
              </p>
            </div>
          </div>
          {loading ? (
