        ...
        <>
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Complete all required course certification exams in your enrolled
              package program to claim your official Package Certification.
            </p>
          </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        claimMutation.variables === progress.packageId ? (
                          ...
                          <>
                            <IconLock size={16} /> Complete Required Exams to
                            Unlock
                          </>
                        )}
                      </button>
                      ...
                      <div className="min-w-0 flex-1">
                        {cert.package && (
                          <p className="text-[11px] uppercase tracking-[0.14em] text-primary-hover font-medium">
                            {cert.autoIssued
                              ? "Package Certificate · Auto-issued"
                              : "Package Certificate"}
                          </p>
                        )}
            ...
            {inProgress.length === 0 ? (
              ...
              <div className="space-y-3">
                {inProgress.map((cert) => {
                  ...
                  const hasCertModule =
                    progress?.hasCertificationModule ?? false;
                  const certQuizPassed =
                    progress?.certificationQuizPassed ?? false;
                  const { percent, contentPercent, examPercent } =
                    computeProgress(progress, cert.progressPercent);
                          ...
                          {progress ? (
                            <div className="mt-3 space-y-1.5">
                              ...
                              <RequirementRow
                                label="Assignments"
                                completed={
                                  progress.details.completedAssignments
                                }
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border border-border/40 bg-background/40 px-2.5 py-1.5">
      ...
      >
        {completed}/{total}{" "}
        {isDone && (
          <IconCheck size={10} className="inline ml-0.5 text-success" />
        )}
      </span>
    </div>
  );
