  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        {(sidebarTab === "all" || sidebarTab === "live") &&
          liveSessions.length > 0 && (
            <div className="px-4 py-3 space-y-3">
              <p className="text-[11px] font-medium text-danger uppercase tracking-wider">
                Live Now
              </p>
        ...
        {(sidebarTab === "all" || sidebarTab === "recordings") &&
