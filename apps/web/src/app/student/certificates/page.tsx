                ...
                >
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <p className="text-xs text-muted-foreground">
                      {certificate.completedRecordings}/
      ...
      <section className="glass-card overflow-hidden">
        ...
        <div className="p-6">
          {data.claimable.length > 0 ? (
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              {data.claimable.map((item) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <p className="text-xs uppercase tracking-[0.14em] text-success">
                        Ready to claim
                      </p>
                      <h3 className="mt-1 text-lg font-semibold text-foreground">
                        {item.course.title}
                  ...
                  <p className="mt-4 text-sm text-muted-foreground">
                    Completed {item.completedRecordings}/{item.totalRecordings}{" "}
                    recordings.
                  </p>
                  <button
            ...
            <div className="rounded-xl border border-dashed border-border/60 bg-background/40 p-6 text-sm text-muted-foreground">
              No courses are ready to claim yet. Finish all recordings in an
              enrolled course and it will appear here.
            </div>
          )}
        </div>
      </section>
