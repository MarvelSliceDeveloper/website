...
const icons = {
  ...
  calendar: [
    "M3 9h18M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5z",
    "M8 2v3M16 2v3",
  ],
          ...
          >
            <div
              style={{
                height: "100%",
                width: `${pct}%`,
                background: "linear-gradient(90deg, #7c6ee0, #a09af0)",
                borderRadius: 99,
                position: "relative",
              }}
            >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.background = "rgba(108,92,231,0.4)")
              }
              onMouseLeave={(e) =>
            ...
            >
              ...
              <span
                style={{ color: "rgba(255,255,255,0.35)", margin: "0 4px" }}
              >
                /
              </span>
              {fmt(duration)}
