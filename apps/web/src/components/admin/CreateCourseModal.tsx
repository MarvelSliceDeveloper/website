...
export function CreateCourseModal({
  ...
  return (
    ...
    >
      <form id="create-course-form-modal" onSubmit={handleSubmit} className="space-y-4">
        <div className="flex flex-wrap items-center gap-2 rounded-lg border border-violet-300/50 bg-violet-500/5 p-3">
          ...
          <p className="w-full text-[10px] text-muted-foreground">
            Fills title, description, category, tags, and objectives below — review and edit before adding.
          </p>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            minLength={10}
          />
          <p className="mt-1 text-xs text-muted">You can add rich formatting in the Course Designer later.</p>
        </div>
        ...
        <div>
          ...
          >
            ...
            <SelectContent>
              ...
              {form.category &&
                !(categoryOptions as readonly string[]).includes(form.category) && (
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            />
            <button type="button" onClick={addTag} className="btn-secondary text-xs px-3">
              <IconPlus size={14} />
            </button>
          </div>
          <p className="mt-1 text-xs text-muted">Tags auto-fill from the course title. You can add or remove them.</p>
        </div>

        <div>
          <label className="mb-1.5 block text-sm font-medium text-foreground">Learning Objectives</label>
          ...
          <div className="flex gap-2">
            <input
              ...
              className="field flex-1"
            />
            <button type="button" onClick={addObjective} className="btn-secondary text-xs px-3">
              <IconPlus size={14} />
            </button>
          </div>
          <p className="mt-1 text-xs text-muted">AI fills this from the draft — you can add or remove items before adding.</p>
        </div>
        ...
        <div className="rounded-xl border border-primary/20 bg-primary/5 px-4 py-3 text-xs text-muted-foreground">
          ...
          <p>
            The course will be created as a <strong>Draft</strong>. You can then add modules, upload videos, design the
            landing page, and publish when ready.
          </p>
        </div>
      </form>
    </FormModal>
