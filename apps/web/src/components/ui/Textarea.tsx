    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <textarea
          ...
          className={cn(
            "w-full rounded-lg border border-border bg-card px-3.5 py-2.5 text-sm text-foreground placeholder:text-muted shadow-2xs transition-all duration-150 resize-y",
